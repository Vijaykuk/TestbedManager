   ...
   syncFlag: function(val) {
    ...
    showingUnique: function(val){
      if(val){
       ...
       this.tableColumns.tc_logs=false;
         ...
         this.tableColumns.tc_testExecOwner=false;
          this.tableColumns.tc_defects=false;
           this.tableColumns.emptyProcedure=false;
      }
      else{
         this.tableColumns={...copyOfTableColumns};
      }
    },
    gotoTestcase:{
      immediate: true,
    ...
    handler(testcaseArray) {
      ...
      for(let i=0;i<testcaseArray.length;i++){
        if(testcaseArray[i].tc_procedure==="" || testcaseArray[i].tc_procedure === null){
...
immediate: true,
  ...
  computed: {
    ...
    idValue: function(){
      let idValue="";
       ...
       idValue=this.folderName+","+this.customerName;
      }
      return idValue;
    }
  },
  methods: {
    ...
    loadChartImages(pos,len,myResolve,myReject){
      let self=this;
      let options=null;
       //here
   /*   if(len-pos<1){
    ...
    exportTestCases() {
      ...
      let myPromise = new Promise(function(myResolve, myReject) {
         self.loadChartImages(0,len,myResolve,myReject);
        });
    ...
    myPromise.then(function(){
      ...
      if(self.releaseFlag==="release"){
        zipfilename=self.selectedCustomerName + "_" + self.selectedReleaseName+"_EoTR.zip";
        title=self.selectedCustomerName + " " + self.selectedReleaseName+" End of Test Report";
      }
      else if(self.releaseFlag==="project"){
        zipfilename=self.selectedCustomerName + "_" + self.selectedProjectName+"_EoTR.zip";
        title=self.selectedCustomerName + "_" + self.selectedProjectName+" End of Test Report";
      }
       ...
       title=self.folderName+" End of Test Report";
        ...
        zipfilename=self.selectedCustomerName+"_EoTR.zip";
        title=self.selectedCustomerName+" End of Test Report";
      }
        ...
        // let zipfilename=customer+"_"+release+"_EoTR.zip"
          ...
          form_data.append("exportFields", JSON.stringify(self.exportColumns));
          form_data.append("displayFields", JSON.stringify(self.tableColumns));
      ...
      if(self.releaseFlag==="release"){
       ...
       testcaseService
            .exportTestCases(self.idValue, self.releaseFlag, form_data)
            .then((response) => response.blob())
            .then(
              (bytes) => {
                let elm = document.createElement("a");
   ...
   /*   let id=this.projectId;
    ...
    expandRow(event,fobj) {
      ...
      let self=this;
        ...
        let topoPath=data.tc_topology,temp=[],tfname="",topoList=[];
       if(topoPath){
          temp=topoPath.split('/');
    ...
    handleSubmit() {
      ...
      testcaseService.bulkUpdateTestCases(form_data).then(
        ...
        self.loading = true;
          ...
          testcaseService.bulkUpdateUniqueTestCases(form_data,this.releaseFlag,this.idValue).then(
          (data) => {
          if (data) { 
            self.loading = false;
            self.loadingMessage = "";
  ...
  <div class="testcasesPage" id="testcasesPage">
    ...
    display: inline-flex;">
        ...
        <div v-if="!showForm" class="tm_btns">
          ...
          <div v-if="showExportMenu && !showingUnique" class="dd_menu">
            ...
            <div class="countList">
              <table class="countTable">
                <tr style="border-top: 1px dotted #c1c1c1;">
                  ...
                  <th class="countTd" v-show="!showingUnique">Defects</th>
                  <th class="countTd" v-show="!showingUnique">Pass</th>
                  <th class="countTd" v-show="!showingUnique">Fail</th>
                  <th class="countTd" v-show="!showingUnique">Pending</th>
                </tr>
                <tr class="totalRow">
                  ...
                  <td class="countTd" v-show="!showingUnique">
                ...
                <tr v-for="(fr, key) in featureCountList" :key="key">
                  ...
                  <td class="countTd" v-show="!showingUnique">{{ fr.defects }}</td>
                  <td class="countTd" v-show="!showingUnique">{{ fr.pass }}</td>
                  <td class="countTd" v-show="!showingUnique">{{ fr.fail }}</td>
                  <td class="countTd" v-show="!showingUnique">{{ fr.pending }}</td>
                </tr>
              </table>
            </div>
          </div>
        ...
        >
          <tbody>
            ...
            >
              ...
              <th class="testcase_td1" style="width:10%;"  v-show="tableColumns.tc_logs">
                Log File
              </th>
              <th
                class="testcase_td1"
              ...
              <th class="testcase_td1" style="width:10%;"   v-show="tableColumns.tc_result">
                Result
              </th>
            </tr>
                  ...
                  >
                    <template v-for="(fobj, index1) in ft.list">
                      ...
                      >
                        ...
                        <td :class="getColorForResult(fobj.tc_result)+' testcase_td'" style="width:10%;" v-show="tableColumns.tc_result">
                          {{ fobj.tc_result }}
                        </td>
                      </tr>
                      <tr
          ...
          <div style="width:20%">
           ...
           <div style="width:20%">
            ...
            <div class="form-group tm-form-group1 row" style="width:100%">
              <div class="form-group__text tm-form__text" style="width:100%" v-if="!showingUnique">
                <textarea
           ...
           <div class="form-group tm-form-group" style="width:20%" v-if="!showingUnique">
          <div class="">
            <input
          ...
          >
            ...
            <div class="row" style="width:97%">
              ...
              <div style="width:20%;text-align: left;">
                ...
                />
                <label class="exportLabel" for="tc_without_procedure">Testcases without Procedure</label>
              </div>
              </div>
