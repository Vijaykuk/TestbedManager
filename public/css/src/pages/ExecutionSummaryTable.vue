         ...
         <div class="modal__body" style="display:flex; justify-content:center;">
          <div class="execSummaryTable">
              ...
              <th class="uTableTh">CVT Raised</th>
               ...
               <tr><td class="uTableTd" style="text-align:center" colspan="2">Summary</td>
               <td class="uTableTd" colspan="11">
            
    <div class="relWeekContentWrapper">
      <div class="summaryContentForWeek">
      <div>{{selectedWeekData.summary}}</div>
      </div>
    </div>
               ...
               <tr><td class="uTableTd" style="text-align:center" colspan="2">Open Issues</td>
               <td colspan="11" class="uTableTd">
                <div class="issuesTable">
               <table id="issuesTable">
               <tr v-if="mainCdets.length>0">
             ...
             <template v-for="(pobj,ip) in execProjects">
                <tr :key="ip+'_ab'">
              <th class="rTableTh projectTd"><span class="foldericon"><i class="icon icon-folder"></i></span><span class="projName">{{pobj.name}}</span></th>
                 <td class="rTableTd ">0 (0.0 %)</td>
                  <td class="rTableTd ">0 (0.0 %)</td>
                   <td class="rTableTd ">0 (0.0 %)</td>
                    <td class="rTableTd "> 0 (0.0 %)</td>
