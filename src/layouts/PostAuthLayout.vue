...
<template>
  <div class="content-fluid">
        ...
        <div class="header-bar container rackHeaderBar">
          <div class="header-bar__main">
            <div class="header-heading">
              ...
              <h1 id="tl-title" class="page-title" v-if="showAppTitle">
                <span class="tl-title-sub">CVT Management System</span>
                <span class="tl-title-sub" style="margin-left:15px">{{
                  customer
                }}</span>
              </h1>
            </div>
          ...
          <div class="firstHeader">
            ...
            >
            <!-- <span class="half-margin-right">|</span> -->
    ...
    margin-top: 20px;"
          ...
          <!-- Chhange Password -->
            <!-- <div class="addUserBlk" v-if="PasswordChange">
            <div style="color:#005073;font-weight:bold;">
              <h5>{{currentUser}}</h5>
            </div>
            <form @submit.prevent
