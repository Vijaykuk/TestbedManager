      ...
      testcases:{
        ...
        for(let m=0;m<PRSummaryDetails.length;m++){
         ...
         for(let m=0;m<allPlatformRoles.length;m++){
          ...
          /*  let sl=0;
            for(let m=0;m<PRSummaryDetails[a].plist.length;m++){
          for(let n=0;n<PRSummaryDetails[a].plist[m].flist.length;n++){
            PRSummaryDetails[a].plist[m].flist[n]["sl_num"]=++sl;
          }
        }*/
         }
...
<template>
 ...
 "
    ...
    padding-left: 35px;width:25%;white-space: nowrap;"
      ...
      <splide v-if="selectedCharts.length>0" :slides="slides" :options="primaryOptions" class="mySlides" id="mySlides">
