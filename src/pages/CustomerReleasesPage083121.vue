...
"#d43d51"
      ...
      quality_platformRole_bar_option1:options.quality_platformRole_bar_option1,
      quality_platformRole_bar_option2:options.quality_platformRole_bar_option2,
  ...
  cdetsOptions3: {
    ...
    series: [
     ...
     pie_option3:options.pie_option3,
  ...
  methods: {
   ...
   deleteFolderClicked(fname) {
    ...
    loadSummaryData(testcases) {
      ...
      for (let kt = 0; kt < testcases.length; kt++) {
        ...
        if( testcases[kt].tc_result === "pass" ||
          testcases[kt].tc_result === "passed"){
           ...
           tempObj1[testcases[kt].tc_platform]={"Executed":1,"Passed":0};
           if( testcases[kt].tc_result === "pass" ||
          testcases[kt].tc_result === "passed"){
            tempObj1[testcases[kt].tc_platform]["Passed"]+=1;
          }
        ...
        if( testcases[kt].tc_result === "pass" ||
          testcases[kt].tc_result === "passed"){
           ...
           tempObj2[testcases[kt].tc_role]={"Executed":1,"Passed":0};
           if( testcases[kt].tc_result === "pass" ||
          testcases[kt].tc_result === "passed"){
            tempObj2[testcases[kt].tc_role]["Passed"]+=1;
          }
      ...
      for(let sh=0;sh<allPlatformRoles.length;sh++){
        ...
        for(let sb=0;sb<allPlatformRoles.length;sb++){
        obj={};
    ...
    let defectsSummaryDetails = {};
      for (let l = 0; l < allDefects.length; l++) {
        defectsSummaryDetails[allDefects[l]] = { count:0, headline:"", testcaseId:[]};
      }
      let temp123 = [];
   ...
   //   }
      ...
      let qualityData=this.loadQualityData("platformRole");
      let qualityPlatformData=this.loadQualityData("platform");
      let qualityRoleData=this.loadQualityData("role");
    ...
    loadReleases() {
      ...
      testcaseService.getReleasesList(self1.customerId).then(
        (data) => {
          ...
          this.loadCDETSData(data[0].id,self1.folders[0]);
      ...
      <div>
        ...
        <div class="slidesBtn">
           ...
           <button
            ...
            <div class="col-lg-4 col-md-4">
               <div class="b_chartDiv">
              <Chart id="chart_a5" class="chartsA" :option="mhHaveOption"></Chart>
            </div>
             <div class="b_chartDiv">
      ...
      <div class="modal__body" style="display:flex; justify-content:center;">
        ...
        <th style="text-align: left;">Count</th>
         <th style="text-align: left;">Testcases</th>
          <th style="text-align: left;white-space:pre-wrap;">Headline</th>
        </tr>
          <tr
          ...
          >
            ...
            <td style="text-align: left;white-space:pre-wrap;">{{ item.headline }}</td>
          </tr>
        </table>
      </div>
    </div>
