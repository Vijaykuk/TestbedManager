    ...
    exeSummaryArr: function(exeSummaryArr) {
      for (let k = 0; k < Object.keys(this.exeSummaryArr).length; k++) {
        if (this.displayName === Object.keys(this.exeSummaryArr)[k]) {
          ...
          this.executionCircleColor = this.getColorForExecution(
            diff
          );
        }
      }
          ...
          (data) => {
           ...
           let submitterWithFilters=[], componentWithFilter=[], statusWithFilter=[];
            ...
            for (let i = 0; i < self.cdets.length; i++) {
              ...
              if(self.cdets[i].status!="J" && self.cdets[i].status!="D" && self.cdets[i].status!="U" && self.cdets[i].status!="C" ){
            ...
            let submitterWithFilters2=[], componentWithFilter2=[], statusWithFilter2=[];
            ...
            for (let n = 0; n < self.cdets.length; n++) {
              ...
              for (let n = 0; n < self.cdets.length; n++) {
               if(self.cdets[n].status!="J" && self.cdets[n].status!="D" && self.cdets[n].status!="U" && self.cdets[n].status!="C" ){
              for (let o = 0; o < submitterWithFilters2.length; o++) {
                if (self.cdets[n]["submitter"] === submitterWithFilters2[o].name) {
                  submitterWithFilters2[o].count += 1;
                }
              }
              for (let p = 0; p < componentWithFilter2.length; p++) {
                if (self.cdets[n]["component"] === componentWithFilter2[p].name) {
            ...
            let submitterWithFilterOption =JSON.parse(JSON.stringify(self.cdetsOptions2));
            ...
            let few2=[];
             let componentWithFilterOption =JSON.parse(JSON.stringify(self.cdets_Options1));
               componentWithFilter2=self.sortByValue(componentWithFilter2,"count");
            ...
            this.statusOption = this.cdetsOptions3;
             ...
             let few3=[]
             let statusWithFilterOption =JSON.parse(JSON.stringify(self.cdetsOptions3));
        ...
        (data) => {
          ...
          for (let a = 0; a < self1.folders.length; a++) {
            ...
            for (let m = 0; m < self1.folderList[a].length; m++) {
              ...
              releasestemplete +=
                '<button type="button" class="collapsibleReleases to-right" data-rellSDate="' +
                rellSDate +
                '"  data-rellEDate="' +
                rellEDate +
                '" data-custName="' +
          ...
          for (let b = 0; b < coll.length; b++) {
            ...
            coll[b].addEventListener("contextmenu", (e) => {
              ...
              let query_string = e.currentTarget.getAttribute("data-query_string");
          ...
          if (self1.redirectToName === "") {
            ...
            let type = self1.redirectToType;
            let name = self1.redirectToName;
            if (type === "folder") {
              let clickflag=true; 
               for (let f1 = 0; f1 < coll.length; f1++) {
                if (coll[f1].getAttribute('data-folder') === self1.redirectToName && clickflag) {
                  clickflag=false;
                ...
                for(let ra=0;ra<coll.length;ra++){
                  let rlName=self1.redirectToName.split('@');
                if(coll[ra].innerText===rlName[0] &&  coll[ra].getAttribute('data-folder')===rlName[1] && clickflag){
                   clickflag=false;
                  coll[ra].click();
                }
                }
                if(!clickFlag){
                for(let ra=0;ra<coll.length;ra++){
                   if (coll[ra].getAttribute('data-folder') === self1.redirectToName && clickflag) {
                  clickflag=false;
                  self1.folderName=self1.redirectToName;
                  coll[f1].click();
                }
          ...
          testcaseService.getFolderByProjectIds().then(
            (fdata) => {
              for (let s = 0; s < self1.releases.length; s++) {
                ...
                let p_template =
                  '<div class="releaseContent" style="display:none;" id="release_' +
                  self1.releases[s].id +
                  '">';
    ...
    <div class="mainDiv">
      <div class="releasesDiv hideReleaseDiv">
        <div class="releasesListDiv">
          <div class="createReleaseBtn"></div>
        ...
        <div class="mainPage" v-if="!showExtraPage">
          <div>
            <div
              ...
              v-show="summary_customers.length > 0"
            >
                ...
                >
                  ...
                  >
                    <div
                      ...
                      @click="
                        custBoxClicked(summary_obj.type, summary_obj.name)
                      "
                    >
          ...
          <div>
            <div class="row releaseSummaryDiv darkBg" v-show="showCustGraphs">
          ...
          <div class="radioTypes" style="padding-left:20px;">
            ...
            <div class="row releaseSummaryDiv1" v-show="showCustGraphs">
              <div class="col-lg-12 col-md-12">
                <div class="belowCharts row belowChartsLight">
          ...
          <div>
            ...
            <div class="row">
              <div class="slidesBtn">
                <div class="slideBtnGroup" style="width:33%">
                  <button
              ...
              >
                ...
                <div class="summaryname">Features</div>
                  ...
                  <button class="r_summaryDiv c_noProcedure"    @click="loadEmptyProcTcs">
                    <div class="totalCount">
