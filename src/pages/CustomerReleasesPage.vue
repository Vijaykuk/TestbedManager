...
import WeeklyUpdatePage from "./WeeklyUpdatePage.vue";
import Header1 from "./Header1.vue";
import MailSamplePage from "./MailSamplePage.vue";
...
import DefectsDetails from "./DefectsDetails.vue";
import AhaListPage from "./AhaListPage.vue";
import CdetsListPage from "./CdetsListPage.vue";
import { json } from 'd3-fetch';
import Http404Page from '../../src123/pages/Http404Page.vue';
...
export default {
  ...
  data() {
    return {
     ...
     userDetails:{},
      ...
      mainCdets: [],
      totalUniqueAutomatedTestcases:0,
      exeSummaryArr: {},
      mailCharts: [],
      statusTabs: [],
      statusTabsArr: {},
      ...
      showLoadingTestcases: false,
      showExecSummaryModal: false,
      showWeeklyUpdateModal: false,
      showMenuBarFlag:false,
      showDefectModal: false,
      showAhaModal: false,
      showCdetsModal: false,
	  showCfdsModal:false,	  
      showSampleMailModal: false,
      ...
      showExtraPage: false,
      showingMasterTcs:false,
      showingActual:true,
      showingUnique: false,
      reloadUnique: false,
      showingEmptyProc: false,
      reloadEmptyProc: false,
      showingWithLogs: false,
      reloadWithLogs: false,
      showingUniqueCharts: false,
      ...
      summaryButtonsDetails: {
        ...
        testcasesPassed: { count: 0, percentage: 0 },
      ...
      folderName: "",
      uploadRelSyncConfirmed: false,
      uploadPrSyncConfirmed: false,
      ...
      cdets_status_data: [],
      componentOption: {},
      componentWithFilterOption: {},
      submitterOption: {},
      submitterWithFilterOption: {},
      mhOption: {},
      statusOption: {},
      statusWithFilterOption: {},
      testcasesFlag: 0,
      qualityOption: {},
      ...
      componentWithFilterFlag: false,
      submitterWithFilterFlag: false,
      statusWithFilterFlag: false,
      ganttOptions: {
        chart: {
  ...
  watch: {
    ...
    showFoldersList:function(newVal){
      let releaseContent=document.querySelectorAll('.releaseContent');
      for(let k=0;k<releaseContent.length;k++){
        if(newVal){
          releaseContent[k].style.display='block';
        }
        else{
          releaseContent[k].style.display='none';
        }
      }
    },

   
    exeSummaryArr: function(exeSummaryArr) {
      for (let k = 0; k < Object.keys(this.exeSummaryArr).length; k++) {
        if (this.displayName === Object.keys(this.exeSummaryArr)[k]) {
          let executed =
            exeSummaryArr[Object.keys(this.exeSummaryArr)[k]].executionSummary
              .executed;
          let planned =
            exeSummaryArr[Object.keys(this.exeSummaryArr)[k]].executionSummary
              .planned;
          let total =
            ...
            exeSummaryArr[Object.keys(this.exeSummaryArr)[k]].executionSummary
              .executed;
          let execPerc = parseInt((executed / total) * 100);
          let plannedPerc = parseInt((planned / total) * 100);
          let diff = plannedPerc - execPerc;
          this.executionCircleColor = this.getColorForExecution(diff);
        }
      }
    },
    selectedCdets: {
  ...
  methods: {
    onChildInteraction(args, payload) {
      switch (args) {
        ...
        case "showMaster":
          ...
          this.showingMasterTcs=true;
          this.showingActual=false;
          break;
        case "showMenubar":
          this.showMenubar();
          break;
        case "showGraphs":
          this.showCustGraphs = !this.showCustGraphs;
          break;
        case "themeClicked":
          this.showSchemeMenu();
          break;
        ...
        case "showChartPopup":
          ...
          break;
        case "showGanttChartPopup":
          this.showGanttChartPopup(payload);
          break;
        case "toggleChart":
          this[payload] = !this[payload];
          break;
        case "gotoActualtcs":
           this.loadActualTestcases();
          break;
        case "gotoUniquetcs":
          this.reloadUnique = true;
          this.loadUniqueTcs();
          break;
        case "closeExecSummaryTable":
          ...
          break;
        case "closeWeeklyUpdateModal":
          this.showWeeklyUpdateModal = false;
          this.showExtraPage = false;
          break;
        case "closeDefectDetailsModal":
          this.showDefectModal = false;
          this.showExtraPage = false;
          break;
        case "closeRelNoteModal":
          this.showRelModal = false;
          this.showExtraPage = false;
          break;
        case "closeAhaListModal":
          this.showAhaModal = false;
          this.showExtraPage = false;
          break;
        case "closeCdetsTableModal":
          this.showCdetsModal = false;
          this.showExtraPage = false;
          break;
		case "closeCfdsTableModal":
          this.showCfdsModal = false;
          this.showExtraPage = false;
          break;						   

        case "closeUpgradeMatrixModal":
          this.showUpgradeMatrixModal = false;
          this.showExtraPage = false;
          break;
        case "closeMailSample":
          this.showSampleMailModal = false;
          break;
        case "closeTriggerMatrixModal":
          this.showTriggerMatrixModal = false;
          this.showExtraPage = false;
          break;
        case "change_custSelectedReleases":
          this.custSelectedReleases = payload;
          break;
        case "loadWeeklyReport":
          this.loadWeeklyReport(this.selectedRelId);
          break;
        case "loadWeeklyReportByCustomerName":
        ...
        authenticationService.getUserList().then(
          ...
          (error) => {
            ...
            if(error.message){
              ...
              this.modalErrorMessage="There is an Error while loading Data Please Check"
            }
    ...
    loadDatabase(){
        let self = this;
      if (this.isAdmin) {
        testcaseService.loadDatabaseDetails().then(
          (data) => {
            // this.loading =true;
            // this.loadingMessage =data.message;
      ...
      loadUserData(){
        ...
        let self = this;
      if (this.isAdmin) {
        testcaseService.getUserData(id).then(
          (data) => {
            // this.loading =true;
            // this.loadingMessage =data.message;
            this.userData = data;
            ...
            if(error.message){
              ...
              self.modalErrorMessage =
              "Error while loading users, Please try again later";
            }
  ...
  updateToken(e) {
    ...
    updatePasswordClicked(){
        ...
        this.loading=true;
        this.loadingMessage='';
      let updatedPassword = JSON.parse(JSON.stringify(this.newUser));
      testcaseService.updatePassword(updatedPassword).then(
         (data) => { 
    ...
    updateTokenClicked(e){
      ...
      this.loading=false;
      this.loadingMessage='';
      let updatedToken = JSON.parse(JSON.stringify(this.newUser));
      testcaseService.updateUserToken(updatedToken).then(
         (data) => {  
          this.loading =true;
          this.loadingMessage =data.message;
          setTimeout(()=>{
          ...
          (error) => {
            ...
            if(error.message){
              ...
              self.modalErrorMessage =
              "Error while updating Token for User, Please try again later";
            }         
          }
      );
      this.showCreateToken = false;
    ...
    updatePasswordToken(e){
      ...
      this.userTitle="Update Password";
      e.preventDefault();

    },

    createtokenforothers(e){
       debugger;
      this.showPasswordChange=false;
      this.adduser = false;
       ...
       let self = this;
      //  this.userObj= this.userDetails[this.currentUser];
    ...
    deleteUserClicked(e,user){
      ...
      debugger;
        ...
        this.showConfirmModal = false;
         ...
         this.loading = true;
        this.loadingMessage = `Deleting User ${user}`;
        let self = this;
        let name=user;
      if (this.isAdmin) {
        testcaseService.deleteUserData({'username':name}).then(
          (data) => {
                this.loading =true;
          this.loadingMessage =data.message;
          setTimeout(()=>{
    ...
    e.preventDefault();
        ...
        this.confirmCallBackName = "userDeleteConfirm";
  ...
  nestedObject(e){
    ...
    this.showCreateToken=true;
        ...
        this.userObj=this.userDetails[e.target.value] || this.userDetails[e.currentTarget.innerText] || this.newUser.name;
        let tokenIdElement =document.querySelector('#tokenid');
        let databaseElement =document.querySelector('#DBname');
        let tokens = this.userObj.token;
        let tokenTemplate ='';
        let dbNameTemplate ='';
        for(let m=0; m<tokens.length;m++){
          tokenTemplate+=`<option value="${tokens[m].tokenid}" >${tokens[m].tokenid} </option>`;
          dbNameTemplate+=`<option value="${tokens[m].DBname}" >${tokens[m].DBname} </option>`;
          this.userToken =tokens[m].tokenid;
          this.userDatabase =tokens[m].DBname;

        }
        tokenIdElement.innerHTML =tokenTemplate;
        databaseElement.innerHTML =dbNameTemplate;

        
       this.newUser.token =tokens[0].tokenid;

       this.newUser.databaseName =tokens[0].DBname;
       this.newUser.username =this.userObj.name;
       this.newUser.role =this.userObj.role;
        
        
    },
  
    tokenIdChanged(e){
      let tokens =this.userDetails[this.newUser.username].token;
      for(let i=0;i<tokens.length;i++){
        if(e.target.value === tokens[i].tokenid){
          this.newUser.databaseName = tokens[i].DBname;
        }
      }
    ...
    dbNameChanged(e){
      ...
      let tokens =this.userDetails[this.newUser.username].token;
      for(let i=0;i<tokens.length;i++){
        if(e.target.value === tokens[i].DBname){
          this.newUser.token = tokens[i].tokenid;
        }
      }
      e.preventDefault();
    ...
    loadMailChartImages() {
      ...
      // debugger;
      var svgElement1 = document.getElementById("timeLineChart");
      // let {width, height} = {};
      let clonedSvgElement1 = svgElement1.cloneNode(true);
      let outerHTML1 = clonedSvgElement1.outerHTML;
      var blob1 = new Blob([outerHTML1], { type: "image/png;charset=utf-8" });
      let blobURL1 = URL.createObjectURL(blob1);
      self.mailCharts.push(blobURL1);
      var svgElement2 = document.getElementById("splineChart");
      // let {width, height} = {};
      let clonedSvgElement2 = svgElement2.cloneNode(true);
      let outerHTML2 = clonedSvgElement2.outerHTML;
      var blob2 = new Blob([outerHTML2], { type: "image/png;charset=utf-8" });
      let blobURL2 = URL.createObjectURL(blob2);
      self.mailCharts.push(blobURL2);
      var svgElement3 = document.getElementById("timeLineChart");
      // let {width, height} = {};
      let clonedSvgElement3 = svgElement3.cloneNode(true);
      let outerHTML3 = clonedSvgElement3.outerHTML;
      var blob3 = new Blob([outerHTML3], { type: "image/png;charset=utf-8" });
      let blobURL3 = URL.createObjectURL(blob3);
      self.mailCharts.push(blobURL3);

      /*  
        var svg = document.querySelector('#timeLineChart').find('svg')[0];
...
img.onload = function() {
    ...
    mailBtnClicked() {
      this.showSampleMailModal = true;
      // this.exportSampleMail();
    },
    ...
    weeklyUpdateLinkClicked() {
      this.hideMenubar();
      this.showWeeklyUpdateModal = true;
    },

    ahaLinkClicked() {
       this.hideMenubar();
      this.showAhaModal = true;
    },
    cdetsLinkClicked() {
         this.hideMenubar();
      this.showCdetsModal = true;
    },
	  cfdsLinkClicked() {
         this.hideMenubar();
      this.showCdetsModal = true;
    ...
    automationLinkClicked() {
         this.hideMenubar();
      if (this.showingUniqueCharts) {
        this.showingUniqueCharts = false;
      } else {
        this.loadUniqueTcsCharts();
      }
    },
    ...
    adjustMarginOfDashboardDiv() {
      document.querySelector(".dashboardDiv").style.marginLeft =
        document.querySelector(".releasesDiv").offsetWidth + "px";
    },
    ...
    applyChangeFunc() {
      ...
      for (let k = 0; k < this.releases.length; k++) {
        if (
          this.releases[k].customerName === this.selectedCustomerName &&
    ...
    renderIcons() {
      ...
      if (!this.guageOptions.series[0].icon) {
        this.guageOptions.series[0].icon = this.renderer
      ...
      this.guageOptions.series[0].icon.translate(
        ...
        this.plotHeight / 2 -
          this.guageOptions.series[0].points[0].shapeArgs.innerR -
          (this.guageOptions.series[0].points[0].shapeArgs.r -
            this.guageOptions.series[0].points[0].shapeArgs.innerR) /
            2
      );
      ...
      if (!this.guageOptions.series[1].icon) {
        this.guageOptions.series[1].icon = this.renderer
          .path([
            "M",
            -8,
            0,
      ...
      this.guageOptions.series[1].icon.translate(
        this.chartWidth / 2 - 10,
        this.plotHeight / 2 -
          this.guageOptions.series[1].points[0].shapeArgs.innerR -
          (this.guageOptions.series[1].points[0].shapeArgs.r -
            this.guageOptions.series[1].points[0].shapeArgs.innerR) /
            2
      );
      ...
      if (!this.guageOptions.series[2].icon) {
        this.guageOptions.series[2].icon = this.renderer
      ...
      this.guageOptions.series[2].icon.translate(
        this.chartWidth / 2 - 10,
        this.plotHeight / 2 -
          this.guageOptions.series[2].points[0].shapeArgs.innerR -
          (this.guageOptions.series[2].points[0].shapeArgs.r -
            this.guageOptions.series[2].points[0].shapeArgs.innerR) /
            2
      );
    },
        ...
        if (input.list instanceof HTMLDataListElement) {
          ...
          input.addEventListener("input", () => {
            ...
            if (valueCount !== currentValueCount) {
              ...
              const str =
                lsIndex !== -1
                  ? input.value.substr(0, lsIndex) + this.separator
                  : "";
    ...
    drawXAxisBackground(e) {
      ...
      if (!xAxis.background) {
        xAxis.background = chart.renderer
          .rect()
          .attr({
    ...
    refreshCFDTab() {
      if (this.selectedCFDRelease) {
        ...
        for (let i = 0; i < this.cfdDataList.length; i++) {
          if (
            this.cfdDataList[i].customer_release === this.selectedCFDRelease
          ) {
    ...
    custBoxClicked(type, custObj) {
      ...
      // self.drawChart(custName, "Customer");
        this.loadCDETSData(custName, self.folderName);
        this.loadWeeklyReportByCustomerName(self.folderName, custName);
        self.ganttOptions.title.text =
          "Project Plan - <span style='font-size:15px;'>" +
          self.folderName +
          ":" +
          custName +
          "</span>";
        self.ganttOptions1.title.text =
          "Project Plan - <span style='font-size:15px'>" +
          self.folderName +
          ":" +
          custName +
          "</span>";
        self.displayName = self.folderName + ":" + custName;
    ...
    loadActualTestcases() {
      ...
      if (this.showingMasterTcs) {
        self.showingMasterTcs = false;
      }
      if (this.showingEmptyProc) {
        self.showingEmptyProc = false;
      }
      if (this.showingWithLogs) {
        self.showingWithLogs = false;
      }
      self.showingActual=true;
    },
    ...
    loadWithLogTcs() {
      if (!this.showingWithLogs || this.reloadWithLogs) {
        let self = this;
        //   self.proj_cust_Selected=false;
        this.reloadWithLogs = false;
        let id = self.releaseId;
        if (self.releaseFlag === "release") {
          id = self.selectedRelId;
        } else if (self.releaseFlag === "project") {
        ...
        self.loading = true;
        self.loadingMessage = "Loading with log testcases...";
        testcaseService.loadWithLogTestcasesDetails(self.releaseFlag, id).then(
          (data) => {
            self.loading = false;
            self.withLogTestcaseDetails = data;
            self.loadingMessage = "";
            self.showingWithLogs = true;
            self.showingActual=false;
          },
          (error) => {
             self.loading = false;
              self.loadingMessage = "";
    ...
    loadEmptyProcTcs() {
      if (!this.showingEmptyProc || this.reloadEmptyProc) {
        let self = this;
        //   self.proj_cust_Selected=false;
        this.reloadEmptyProc = false;
        let id = self.releaseId;
        if (self.releaseFlag === "release") {
          id = self.selectedRelId;
        } else if (self.releaseFlag === "project") {
        ...
        testcaseService
          .loadEmptyProcedureTestcasesDetails(self.releaseFlag, id)
          .then(
            (data) => {
              self.loading = false;
              self.emptyProcedureTestcaseDetails = data;
              self.loadingMessage = "";
              self.showingEmptyProc = true;
              self.showingActual=false;
            },
            (error) => {
              self.loading = false;
    ...
    loadUniqueTcs() {
      if (!this.showingUnique || this.reloadUnique) {
        let self = this;
        //   self.proj_cust_Selected=false;
        this.reloadUnique = false;
        let id = self.releaseId;
        if (self.releaseFlag === "release") {
          id = self.selectedRelId;
        } else if (self.releaseFlag === "project") {
        ...
        self.loading = true;
        self.loadingMessage = "Loading unique testcases...";
        testcaseService.loadUniqueTestcasesDetails(self.releaseFlag, id).then(
          (data) => {
            self.loading = false;
            self.totalUniqueAutomatedTestcases =
              data.data0.Auto_vs_maual.Automated;
            self.uniqueTestcaseDetails = data.data0;
            self.loadingMessage = "";
    ...
    loadSummaryBoxDetails(data) {
      let self = this;
      for (let sh = 0; sh < this.summary_customers.length; sh++) {
        this.summary_customers[sh]["showSplide"] = false;
      }
      if (Object.keys(data).length > 0) {
        ...
        for (let k = 0; k < summaryKeys.length; k++) {
          ...
          this.summary_customers[k]["showSplide"] = true;
          ...
          self.summary_customers[k]["customer_name"] =
            data[summaryKeys[k]].executionSummary.customer_name;
          self.summary_customers[k]["failed"] =
            data[summaryKeys[k]].executionSummary.failed;
          self.summary_customers[k]["passed"] =
            data[summaryKeys[k]].executionSummary.passed;
          self.summary_customers[k]["pending"] =
            data[summaryKeys[k]].executionSummary.pending;
          self.summary_customers[k]["executed"] =
            data[summaryKeys[k]].executionSummary.executed;
          self.summary_customers[k]["planned"] =
            data[summaryKeys[k]].executionSummary.planned;
          self.summary_customers[k]["summary"] =
            data[summaryKeys[k]].executionSummary.summary;
          self.summary_customers[k]["total"] =
            data[summaryKeys[k]].executionSummary.executed +
            data[summaryKeys[k]].executionSummary.pending;
          self.summary_customers[k]["qualityClass"] = "";
          self.summary_customers[k]["onTrackDelay"] = "";
          self.summary_customers[k]["executedPerc"] = parseInt(
            (self.summary_customers[k]["executed"] /
              self.summary_customers[k]["total"]) *
              100
          );
          self.summary_customers[k]["plannedPerc"] = parseInt(
            (self.summary_customers[k]["planned"] /
              self.summary_customers[k]["total"]) *
              100
          );
          self.summary_customers[k]["quality"] = parseInt(
            (data[summaryKeys[k]].executionSummary.passed /
              data[summaryKeys[k]].executionSummary.executed) *
              100
          );
          ...
          let diff =
            self.summary_customers[k]["plannedPerc"] -
            self.summary_customers[k]["executedPerc"];
          execution1Options = self.loadGuageOptions(
            self.summary_customers[k]["executedPerc"],
            "execution",
            diff
          );
          qualityOptions = self.loadGuageOptions(
            self.summary_customers[k]["quality"],
            "quality"
          );
          ...
          this.summary_customers[k]["execution1Options"] = JSON.parse(
            JSON.stringify(execution1Options)
          );
          this.summary_customers[k]["executionOptions"] = JSON.parse(
            JSON.stringify(executionOptions)
          );
          this.summary_customers[k]["qualityOptions"] = JSON.parse(
      ...
      testcaseService.customerExecutionSummary(folderName).then(
        (data1) => {
          ...
          for (let x = 0; x < Object.keys(data1).length; x++) {
            ...
            data1[Object.keys(data1)[x]]["folder"]=folderName;
            self.customers.push(Object.keys(data1)[x]);
          }
          ...
          testcaseService.projectExecutionSummary(folderName).then(
            (data2) => {
              ...
              self.exeSummaryArr = {};
              self.exeSummaryArr = Object.assign(data1, data2);
              if (Object.keys(data2).length > 1) {
                ...
                let tempData={};
                for(let m = 0; m < keys.length; m++){
                  if(keys[m]===self.selectedReleaseName || keys[m] === self.customerName){
                    tempData[keys[m]]=data[keys[m]];
                  }
                }
    ...
    deleteFolderClicked(fname) {
      ...
      if (this.deleteConfirmed === true) {
        ...
        this.showConfirmModal = true;
        this.confirmCallBackName = "confirmDelete";
    ...
    deleteReleaseClicked(robj) {
      ...
      if (this.deleteConfirmed === true) {
        ...
        this.deleteObj = robj;
        this.modalConfirmMessage =
          "Are you sure you want to delete " + robj.rname;
      }
    ...
    stripHtml(html)
{
   ...
   return tmp.textContent || tmp.innerText || "";
    ...
    cloneReleaseClicked(fname) {
      this.$refs.rmenu.close();
      this.loading = true;
      this.loadingMessage = "Clone project is in progress..";
      testcaseService.cloneRelease(fname).then(
        (data) => {
          this.loading = false;
          this.loadingMessage = "";
          this.showInfoModal = true;
    ...
    cloneProjectClicked(e, robj) {
      this.$refs.rmenu.close();
      this.loading = true;
      this.loadingMessage = "Clone project is in progress..";
      testcaseService.cloneProject(robj.rid).then(
        (data) => {
          this.loading = false;
          this.loadingMessage = "";
          this.showInfoModal = true;
    ...
    updateCdetsRelBtnClicked(e, robj) {
      this.$refs.rmenu.close();
      this.loading = true;
      this.loadingMessage = "Updating the Cdets..";
      testcaseService.updateCdets(robj.rid).then(
        (data) => {
          this.loading = false;
          this.loadingMessage = "";
          this.modalInfoMessage = "Cdets Updated.";
        },
        (error) => {
          this.loading = false;
          this.loadingMessage = "";
          ...
          if(error.message){
            ...
            this.modalErrorMessage =
              "Error while updating cdets, Please try again later";
    ...
    uploadRelSyncBtnClicked(e, robj) {
      this.$refs.rmenu.close();
      if (this.uploadRelSyncConfirmed === true) {
        this.uploadRelSyncConfirmed = false;
        this.showConfirmModal = false;
        this.loading = true;
        this.loadingMessage = "Sync with Tims in progress..";
        testcaseService.uploadReleaseSyncWithTims(robj.rid).then(
          ...
          (error) => {
            ...
            if (error.message) {
              ...
              this.modalErrorMessage =
                "Error while sync, Please try again later";
            }
          }
        );
      } else {
        this.showConfirmModal = true;
        this.confirmCallBackName = "uploadRelSyncConfirm";
        this.uploadRelObj = robj;
        this.modalConfirmMessage = "Are you sure you want to upload to tims";
      }
      event.preventDefault();
    },
    uploadPrSyncBtnClicked(event, pobj) {
      this.$refs.rmenu.close();
      if (this.uploadPrSyncConfirmed === true) {
        this.uploadPrSyncConfirmed = false;
        this.showConfirmModal = false;
        this.loading = true;
        this.loadingMessage = "Sync with Tims in progress..";
        ...
        this.showConfirmModal = true;
        this.confirmCallBackName = "uploadPrSyncConfirm";
        this.uploadPrObj = pobj;
        this.modalConfirmMessage = "Are you sure you want to upload to tims";
      }
      event.preventDefault();
    },
    deleteProjectClicked(e, pobj) {
      ...
      if (this.deleteConfirmed === true) {
        ...
        this.deleteObj = pobj;
        this.modalConfirmMessage =
          "Are you sure you want to delete " + pobj.pname;
      }
      event.preventDefault();
    },
    showCFDTable() {
        ...
        for (let s = 0; s < temp124.length; s++) {
          ...
          for (let h = 0; h < this.cfdDataList.length; h++) {
            if (this.cfdDataList[h].defect_id === temp124[s]) {
              cfdSummaryDetails[temp124[s]]["headline"] = this.cfdDataList[
                h
              ].headline;
              cfdSummaryDetails[temp124[s]]["component"] = this.cfdDataList[
                h
              ].component;
              cfdSummaryDetails[temp124[s]]["product"] = this.cfdDataList[
                h
              ].product;
            }
          }
          ...
          events: {
            render: (e) => {
              ...
              if (!seriesList[0].icon) {
                seriesList[0].icon = this.renderer
                  .path(["M", -8, 0, "L", 8, 0, "M", 0, -8, "L", 8, 0, 0, 8])
                  .attr({
                    stroke: "#303030",
                    "stroke-linecap": "round",
              ...
              seriesList[0].icon.translate(
                this.chartWidth / 2 - 10,
                this.plotHeight / 2 -
                  seriesList[0].points[0].shapeArgs.innerR -
                  (seriesList[0].points[0].shapeArgs.r -
                    seriesList[0].points[0].shapeArgs.innerR) /
                    2
              );
              ...
              if (!seriesList[1].icon) {
                seriesList[1].icon = this.renderer
                  .path([
                    "M",
                    -8,
                    0,
              ...
              seriesList[1].icon.translate(
                this.chartWidth / 2 - 10,
                this.plotHeight / 2 -
                  seriesList[1].points[0].shapeArgs.innerR -
                  (seriesList[1].points[0].shapeArgs.r -
                    seriesList[1].points[0].shapeArgs.innerR) /
                    2
              );
              ...
              if (!seriesList[2].icon) {
                seriesList[2].icon = this.renderer
                  .path(["M", 0, 8, "L", 0, -8, "M", -8, 0, "L", 0, -8, 8, 0])
                  .attr({
                    stroke: "#303030",
                    "stroke-linecap": "round",
              ...
              seriesList[2].icon.translate(
                this.chartWidth / 2 - 10,
                this.plotHeight / 2 -
                  seriesList[2].points[0].shapeArgs.innerR -
                  (seriesList[2].points[0].shapeArgs.r -
                    seriesList[2].points[0].shapeArgs.innerR) /
                    2
              );
            },
    ...
    showMenubar(){
      this.showMenuBarFlag=!this.showMenuBarFlag;
    },
    hideMenubar(){
      this.showMenuBarFlag=false;
    },
    hideSidebar() {
    ...
    showSidebar() {
      if (this.sidebarHidden) {
        ...
        document
          .querySelector(".releasesDiv")
          .classList.remove("hideReleaseDiv");
        document
          .querySelector(".releasesListDiv")
    ...
    loadMultiBarChartDataForUser() {
      ...
      let allUsers = this.summaryButtonsDetails.tc_execution_owners
        ? Object.keys(this.summaryButtonsDetails.tc_execution_owners)
        : [];
      let testcaseList = [],
        defectList = [];
      for (let j = 0; j < allUsers.length; j++) {
        let testcaseCount = userList[allUsers[j]].testcase_id
          ? userList[allUsers[j]].testcase_id.split(",").length
          : 0;
        testcaseList.push(testcaseCount);
        let defectsCount = userList[allUsers[j]].defects
          ? userList[allUsers[j]].defects.split(",").length
          : 0;
        defectList.push(defectsCount);
      }
    ...
    checkPassOrFail(testcase) {
      ...
      if (testcase.tc_result === "passed" || testcase.tc_result === "pass") {
        ...
        testcase.tc_result === "failed" ||
        testcase.tc_result === "fail"
      ) {
        ...
        for (let ab = 0; ab < temp123.length; ab++) {
          ...
          for (let h = 0; h < this.cdets.length; h++) {
            if (this.cdets[h].defect_id === temp123[ab]) {
              if (
                this.cdets[h].status === "R" ||
                this.cdets[h].status === "M" ||
                this.cdets[h].status === "V" ||
                this.cdets[h].status === "J"
              ) {
                testcasepass = true;
              } else {
                testcasepass = false;
    ...
    loadProjectedSummaryChartData(testcases) {
      ...
      for (let i = 0; i < testcases.length; i++) {
        if (
          testcases[i].tc_result === "passed" ||
          testcases[i].tc_result === "pass"
        ) {
          passed += 1;
        } else if (
          testcases[i].tc_result === "failed" ||
          testcases[i].tc_result === "fail"
        ) {
          temp123 = this.testcases[i].tc_defects
            ? this.testcases[i].tc_defects.split(",")
            : [];
          let testcasepass = false;
          for (let ab = 0; ab < temp123.length; ab++) {
            temp123[ab] = temp123[ab].trim();
      ...
      let projectedSummary = [
        { name: "passed", color: color["passed"], y: passed },
        { name: "failed", color: color["failed"], y: failed },
      ];
    ...
    uploadRelSyncConfirm(e) {
      this.showConfirmModal = false;
      this.uploadRelSyncConfirmed = true;
      this.uploadRelSyncBtnClicked(e, this.uploadRelObj);
    },
    uploadPrSyncConfirm(e) {
      this.showConfirmModal = false;
      this.uploadPrSyncConfirmed = true;
      this.uploadPrSyncBtnClicked(e, this.uploadPrObj);
    },
    confirmDelete(e) {
    ...
    userDeleteConfirm(e) {
        debugger;
      this.deleteConfirmed = true;
      this.deleteUserClicked(e,this.deleteUser)
    },
      ...
      if (filterName === "passed") {
        for (let k = 0; k < this.testcases.length; k++) {
          if (
            ...
            this.testcases[k].tc_result === "pass"
          ) {
        ...
        for (let k = 0; k < this.testcases.length; k++) {
          if (
            ...
            this.testcases[k].tc_result === "fail"
          ) {
            selectedTestcases.push(this.testcases[k]);
          }
        }
    ...
    loadGanttChart(relId) {
      ...
      testcaseService.getReleaseDetailsByReleaseId(relId).then(
        (data) => {
          ...
          let revents = data[1];
          let reventTypes = [];
          for (let sh = 0; sh < revents.length; sh++) {
            if (reventTypes.indexOf(revents[sh].event_type) < 0) {
              reventTypes.push(revents[sh].event_type);
            }
          }
          self.eventTypes = reventTypes;

          self.showTims = true;
          self.timsId = rdata.tims_id;
          self.timsUrl = rdata.tims_url;
          self.currentPhase = "";
          let projectStart_date = rdata.start_date;
          let projectEnd_date = rdata.actual_eotr_date;

          self.compareDates(rdata);
          if (revents.length > 0) {
            let sortedEvents = self.sortByDate(revents, "event_start_date");
            if (
              new Date(sortedEvents[sortedEvents.length - 1].event_start_date) <
              new Date(rdata.start_date)
            ) {
              projectStart_date =
                sortedEvents[sortedEvents.length - 1].event_start_date;
            }
            if (
              new Date(sortedEvents[0].event_end_date) >
              new Date(rdata.actual_eotr_date)
            ) {
              projectEnd_date = sortedEvents[0].event_end_date;
            }
          }
          let project_start_date = {
            year: new Date(projectStart_date).getFullYear(),
            month: new Date(projectStart_date).getMonth(),
            date: new Date(projectStart_date).getDate(),
          };

          let project_end_date = {
            year: new Date(projectEnd_date).getFullYear(),
            month: new Date(projectEnd_date).getMonth(),
            date: new Date(projectEnd_date).getDate(),
          };

          // project_start_date=self.getOldestLatestDate(revents[e].event_start_date,rdata.start_date,project_start_date);
          ...
          self.ganttOptions.xAxis[0].min = Date.UTC(
            project_start_date.year,
            project_start_date.month,
            project_start_date.date
          );
          self.ganttOptions.xAxis[0].max = Date.UTC(
            project_end_date.year,
            project_end_date.month,
            project_end_date.date + 7
          );
          self.ganttOptions.xAxis[1].min = Date.UTC(
            project_start_date.year,
            project_start_date.month,
            project_start_date.date
          );
          //self.ganttOptions.xAxis[1].max=Date.UTC(actual_eotr_date.year,actual_eotr_date.month,actual_eotr_date.date+7);
          self.ganttOptions.xAxis[1].max = Date.UTC(
            project_end_date.year,
            project_end_date.month,
            project_end_date.date + 7
          );
          //  self.ganttOptions1.xAxis[2].min=Date.UTC(start_date.year,start_date.month,start_date.date);
          //self.gayAnttOptions1.xAxis[2].max=Date.UTC(fcs_date.year,fcs_date.month,fcs_date.date+7);
          var yAxis = ["-", "Actual", "Planned"];
          yAxis = yAxis.concat(self.eventTypes);
          self.ganttOptions.yAxis.categories = yAxis;
          ...
          if (revents) {
            ...
            for (let k = 0; k < revents.length; k++) {
              ...
              self.ganttOptions.series[0].data.push({
                ...
                y: self.ganttOptions.yAxis.categories.indexOf(
                  revents[k].event_type
                ),
              });
            }
          }
    ...
    loadHeatMapOptionForUsers(data) {
      let valueArray1 = [],
        valueArray2 = [],
        valueObj = [],
        valueObj1 = [],
      ...
      for (let k = 0; k < data.length; k++) {
        let temp1 =
          data[k].test_execution_owner != null
            ? JSON.parse(
                data[k].test_execution_owner
                  .replace(/["']/g, "\*")
                  .replace(/[*]/g, '"')
              )
            : [];
        for (let s = 0; s < Object.keys(temp1).length; s++) {
          if (allUsers1.indexOf(Object.keys(temp1)[s]) < 0) {
            allUsers1.push(Object.keys(temp1)[s]);
          }
        }

        let temp2 =
          data[k].filter_submitter_wise != null
            ? JSON.parse(
                data[k].filter_submitter_wise
                  .replace(/["']/g, "\*")
                  .replace(/[*]/g, '"')
              )
            : [];
        for (let s1 = 0; s1 < Object.keys(temp2).length; s1++) {
          if (allUsers2.indexOf(Object.keys(temp2)[s1]) < 0) {
            allUsers2.push(Object.keys(temp2)[s1]);
          }
        }
      }
      /* for (let j = 0; j < allUsers.length; j++) {
         let testcaseCount=userList[allUsers[j]].testcase_id?userList[allUsers[j]].testcase_id.split(',').length:0;
         testcaseList.push(testcaseCount);
         let defectsCount=userList[allUsers[j]].defects?userList[allUsers[j]].defects.split(',').length:0;
       defectList.push(defectsCount)
       }*/
      for (let i = 0; i < data.length; i++) {
        weekDates.push(data[i].end_date.substring(0, 10));
        let temp1 =
          data[i].test_execution_owner != null
            ? JSON.parse(
                data[i].test_execution_owner
                  .replace(/["']/g, "\*")
                  .replace(/[*]/g, '"')
              )
            : [];
        let temp2 =
          data[i].filter_submitter_wise != null
            ? JSON.parse(
                data[i].filter_submitter_wise
                  .replace(/["']/g, "\*")
                  .replace(/[*]/g, '"')
              )
            : [];
        let weeklyTCExOwners = Object.keys(temp1);
        let weeklySubmitters = Object.keys(temp2);
        for (let k = 0; k < allUsers1.length; k++) {
          if (weeklyTCExOwners.indexOf(allUsers1[k]) >= 0) {
            valueObj = {};
            valueObj["x"] = i;
            valueObj["y"] = k;
            valueObj["value"] = parseInt(temp1[allUsers1[k]]);
            valueObj["color"] = "#08c3fe";
        ...
        for (let k = 0; k < allUsers2.length; k++) {
          if (weeklySubmitters.indexOf(allUsers2[k]) >= 0) {
            valueObj = {};
            valueObj["x"] = i;
            valueObj["y"] = k;
            valueObj["value"] = parseInt(temp2[allUsers2[k]]);
            valueObj["color"] = "#08c3fe";
      ...
      let userHeatMapOptions1 = this.loadHeatMapOptions();
      let userHeatMapOptions2 = this.loadHeatMapOptions();

      userHeatMapOptions1.title.text = "";
      userHeatMapOptions2.title.text = "";
      userHeatMapOptions1.xAxis.categories = weekDates;
      userHeatMapOptions2.xAxis.categories = weekDates;

      userHeatMapOptions1.yAxis.categories = [];
      userHeatMapOptions2.yAxis.categories = [];
      userHeatMapOptions1.yAxis.categories = allUsers1;
      userHeatMapOptions2.yAxis.categories = allUsers2;

      userHeatMapOptions1.series[0].data = valueArray1;
      userHeatMapOptions2.series[0].data = valueArray2;

      this.userHeatMapOptions1 = userHeatMapOptions1;
      this.userHeatMapOptions2 = userHeatMapOptions2;
    },
    ...
    updateReleaseDetails() {
      ...
      this.releaseDetails1["selectedProjectsForChange"] = [
        ...new Set(this.custSelectedReleases),
      ];
      testcaseService
        .updateRelease([this.releaseDetails1], self.selectedRelId)
        .then(
          (data) => {
    ...
    updateSplinetableRow() {
      ...
      if (self.weeklyReportFlag === "relId") {
        testcaseService
          .updateWeeklyReportByReleaseId(weeklyreport, self.selectedRelId)
          .then(
            (data) => {
        ...
        testcaseService
          ...
          .then(
            (data) => {
              ...
              self.showSplineDataTable = false;
              self.showCVTDataTable = false;
              self.loadWeeklyReportByCustomerName(
                self.folderName,
    ...
    loadWeeklyReportByCustomerName(folderName, custName) {
      ...
      testcaseService.getWeeklyReportByCustomer(folderName, custName).then(
        (data) => {
          ...
          let data1 = self.sortByDateAsc(data, "start_date");
          self.loadWeeklyReportDetails(data1);
        },
        (error) => {
          self.loading = false;
          self.loadingMessage = "";
    ...
    loadCDETSData(id, folderName) {
      let self = this;
      let req_id = id;
      this.cdetsReleaseFolderName = folderName;
      if (this.releaseFlag === "release" || this.releaseFlag === "customer") {
        if (this.releaseFlag === "customer") {
          req_id = folderName + "," + id;
        }
        testcaseService.getCDETSDetails(this.releaseFlag, req_id).then(
          (data) => {
            self.loading = true;
            ...
            for (let i = 0; i < self.cdets.length; i++) {
              ...
              if (
                self.cdets[i].status != "J" &&
                self.cdets[i].status != "D" &&
                self.cdets[i].status != "U" &&
                self.cdets[i].status != "C"
              ) {
                submitterWithFilters.push(self.cdets[i].submitter);
                componentWithFilter.push(self.cdets[i].component);
                statusWithFilter.push(self.cdets[i].status);
              }
            }
            ...
            let submitterWithFilters1 = [...new Set(submitterWithFilters)];
            let componentWithFilter1 = [...new Set(componentWithFilter)];
            let statusWithFilter1 = [...new Set(statusWithFilter)];

            let submitters2 = [],
              cdet_components2 = [],
              cdet_status2 = [];

            let submitterWithFilters2 = [],
              componentWithFilter2 = [],
              statusWithFilter2 = [];

            for (let x = 0; x < submitterWithFilters1.length; x++) {
              submitterWithFilters2.push({
                name: submitterWithFilters1[x],
                count: 0,
              });
            }
            for (let x = 0; x < componentWithFilter1.length; x++) {
              componentWithFilter2.push({
                name: componentWithFilter1[x],
                count: 0,
              });
            }
            for (let x = 0; x < statusWithFilter1.length; x++) {
              statusWithFilter2.push({
                name: statusWithFilter1[x],
                count: 0,
              });
            }
            ...
            for (let n = 0; n < self.cdets.length; n++) {
              if (
                self.cdets[n].status != "J" &&
                self.cdets[n].status != "D" &&
                self.cdets[n].status != "U" &&
                self.cdets[n].status != "C"
              ) {
                for (let o = 0; o < submitterWithFilters2.length; o++) {
                  if (
                    self.cdets[n]["submitter"] === submitterWithFilters2[o].name
                  ) {
                    submitterWithFilters2[o].count += 1;
                  }
                }
                for (let p = 0; p < componentWithFilter2.length; p++) {
                  if (
                    self.cdets[n]["component"] === componentWithFilter2[p].name
                  ) {
                    componentWithFilter2[p].count += 1;
                  }
                }
                for (let q = 0; q < statusWithFilter2.length; q++) {
                  if (self.cdets[n]["status"] === statusWithFilter2[q].name) {
                    statusWithFilter2[q].count += 1;
                  }
                }
              }
            }
            ...
            let submitterWithFilterOption = JSON.parse(
              JSON.stringify(self.cdetsOptions2)
            );
            for (let rw = 0; rw < submitterWithFilters2.length; rw++) {
              arr = [];
              arr.push(submitterWithFilters2[rw].name);
              arr.push(submitterWithFilters2[rw].count);
              few1.push(arr);
            }
            submitterWithFilterOption.series[0].data = few1;
            submitterWithFilterOption.title.text = "With JUDC filter";
            this.submitterWithFilterOption = { ...submitterWithFilterOption };
            ...
            let few2 = [];
            let componentWithFilterOption = JSON.parse(
              JSON.stringify(self.cdets_Options1)
            );
            componentWithFilter2 = self.sortByValue(
              componentWithFilter2,
              "count"
            );
            for (let rw = 0; rw < componentWithFilter2.length; rw++) {
              few2.push(componentWithFilter2[rw].count);
            }

            componentWithFilterOption.series[0].data = few2;
            componentWithFilterOption.title.text = "With JUDC filter";
            this.componentWithFilterOption = { ...componentWithFilterOption };
            ...
            let few3 = [];
            let statusWithFilterOption = JSON.parse(
              JSON.stringify(self.cdetsOptions3)
            );
            for (let rw = 0; rw < statusWithFilter2.length; rw++) {
              arr = [];
              arr.push(statusWithFilter2[rw].name);
              arr.push(statusWithFilter2[rw].count);
              few3.push(arr);
            }
            statusWithFilterOption.series[0].data = few3;
            statusWithFilterOption.title.text = "With JUDC filter";
            this.statusWithFilterOption = { ...statusWithFilterOption };
    ...
    showActual(){
      this.showingUnique=false;
      this.showingEmptyProc=false;
      this.showingMasterTcs=false;
      this.showingWithLogs=false;
      this.showingActual=true;
    },
    loadTestcases(id) {},
    ...
    drawChart(id, type) {
      ...
      if (type === "Release") {
        ...
        let q = "?\page=" + pageNumber;
        testcaseService
          .getTestcaseListByCustomerFolderName(id, self.folderName, q)
          .then(
            (res) => {
              let data = res.data;
              let testcases = data;
    ...
    updateCdetsDetails() {
      let temp123 = "";
      let testcaseOwers = [];
      for (let q = 0; q < this.selectedCdets.legth; q++) {
        this.selectedCdets[h]["tcCount"] = 0;
        this.selectedCdets[h]["tcFailures"] = 0;
        this.selectedCdets[h]["tcBlockers"] = 0;
      }
      for (let x = 0; x < this.testcases.length; x++) {
        temp123 = this.testcases[x].tc_defects
          ? this.testcases[x].tc_defects.split(",")
          : [];
        for (let ab = 0; ab < temp123.length; ab++) {
          temp123[ab] = temp123[ab].trim();
          temp123[ab] = temp123[ab].substring(0, 10);
          for (let h = 0; h < this.selectedCdets.length; h++) {
            if (this.selectedCdets[h].defect_id === temp123[ab]) {
              ...
              if (
                this.testcases[x].tc_result.toLowerCase() === "fail" ||
                this.testcases[x].tc_result.toLowerCase() === "failed"
              ) {
                this.selectedCdets[h]["tcFailures"] += 1;
              } else if (
                this.testcases[x].tc_result.toLowerCase() === "blocked"
              ) {
                this.selectedCdets[h]["tcBlockers"] += 1;
              }
            }
          }
        }
    ...
    editReleaseClicked(e, robj) {
      ...
      this.releaseObj = {
        ...
        franchise: robj.franchise,
        query_string: robj.query_string !="null" ? robj.query_string : null,
        email_alias:robj.email_alias !="null" ? robj.email_alias:null,
        weekly_ReportFlag:robj.weekly_ReportFlag === 'true' ? true : false,
        ...
        retest_start_date:
          robj.retest_start_date != "null" ? robj.retest_start_date : null,
        retest_end_date:
          robj.retest_end_date != "null" ? robj.retest_end_date : null,
        longevity_start_date:
          robj.longevity_start_date != "null"
            ? robj.longevity_start_date
            : null,
        longevity_end_date:
          robj.longevity_end_date != "null" ? robj.longevity_end_date : null,
    ...
    getRelSummary(relname) {
      for (let i = 0; i < this.releases.length; i++) {
        if (this.releases[i].name === relname) {
          return this.releases[i].summary != null
            ? this.releases[i].summary
            : "";
        }
      }
      return "";
    ...
    getRelDefectSummary(relname) {
      for (let i = 0; i < this.releases.length; i++) {
        if (this.releases[i].name === relname) {
          return this.releases[i].defect_summary != null
            ? this.releases[i].defect_summary
            : "";
        }
      }
      return "";
    ...
    updateExecutionDefectSummary(type) {
      ...
      testcaseService
        .updateWeeklyReportByReleaseId(this.weekly, this.selectedRelId)
        .then(
          (data) => {
            this.loading = false;
            this.loadingMessage = "";
      ...
      testcaseService.getReleasesList().then(
        (data) => {
          ...
          for (let i = 0; i < sortedData.length; i++) {
            let fl = sortedData[i].folder_name
              ? sortedData[i].folder_name
              : "Unnamed";
            folders.push(fl);
          }
          ...
          for (let k = 0; k < self1.folders.length; k++) {
            let fl_name = self1.folders[k].replaceAll(".", "");
            folderTemplate +=
              '<div class="folderParent folderParent_'+fl_name+'"><button type="button" class="collapsibleFolders activePR activeBtn to-right"';
            folderTemplate +=
              'id="folder_' +
              fl_name +
              '"><span style="width:90%">' +
          ...
          let showFolderTemplate='<div class="showFolders"><input type="checkbox" @click="showFoldersList=!showFoldersList" class="form-check-input showFolderbtn"/>Show Folders</label></div>';
          releasesBtnlist.innerHTML = folderTemplate+showFolderTemplate;
          let showFolderbtn=document.querySelector('.showFolderbtn');
          showFolderbtn.addEventListener(
              "click",
              function(e) {
                self1.showFoldersList=!self1.showFoldersList;
              });
          ...
          let customerListForFolder={};
          let tempFolders= [...new Set(self1.folders)];
          for(let z=0;z< tempFolders.length;z++){
             customerListForFolder[tempFolders[z]]=[];
            for (let ma = 0; ma < self1.folderList[z].length; ma++) {
              let cname=self1.folderList[z][ma].customerName ? self1.folderList[z][ma].customerName : "na";
             if(customerListForFolder[tempFolders[z]].indexOf(cname)<=-1){
              customerListForFolder[tempFolders[z]].push(cname);
             }
                }
          }
          ...
          for (let a = 0; a < self1.folders.length; a++) {
            custTemplate = "<div class='folderContent'>";
            let tempcustomers=customerListForFolder[self1.folders[a]];
            custTemplate+="<div class='collapsibleCustParent'>"
            for(let p=0;p<tempcustomers.length;p++){
            custTemplate+='<button type="button" class="collapsibleCustomer  to-right cust_'+self1.folders[a]+'_'+tempcustomers[p]+'" data-folder="' +
                self1.folders[a] +
                '" id="cust_'+self1.folders[a]+'_'+tempcustomers[p]+'" >'+tempcustomers[p]+'</button>'
            }
             custTemplate+='</div>'
             folderDivIdName = "folder_" + this.folders[a];
            if (folderDivIdName.indexOf(".")) {
              folderDivIdName = folderDivIdName.replaceAll(".", "");
            }
            let folderDiv = document.querySelector("#" + folderDivIdName);
            folderDiv.insertAdjacentHTML("afterend", custTemplate);
          }
            for (let a = 0; a < self1.folders.length; a++) {
            for (let m = 0; m < self1.folderList[a].length; m++) {
              ...
              let custName = data1.customerName ? data1.customerName : "na";
               let custFolderId='cust_'+self1.folders[a]+'_'+custName;
              ...
              let franchise = data1.franchise;
              let query_string = data1.query_string;
              let email_alias = data1.email_alias;
              let weekly_ReportFlag =data1.weekly_ReportFlag;
              ...
              releasestemplete +=
                '<div class="collapsibleParent"><button type="button" class="collapsibleReleases activePR to-right" data-rellSDate="' +
                rellSDate +
                '"  data-rellEDate="' +
                rellEDate +
                '" data-custName="' +
                ...
                data1.name +
                "</span></button></div>";
              let folderDiv = document.querySelector("#" + custFolderId);
            folderDiv.insertAdjacentHTML("afterend", releasestemplete);
            }
                 }

          var cust1= document.getElementsByClassName("collapsibleCustomer");
          for(let c=0;c<cust1.length;c++){
              cust1[c].addEventListener(
              "click",
              function(e) {
                    let folderName = e.currentTarget.getAttribute("data-folder");
                self1.folderName=folderName;
               self1.custBoxClicked("customer",event.currentTarget.innerText)
              });
           }
          ...
          for (let t = 0; t < fol1.length; t++) {
            ...
            fol1[t].addEventListener(
              ...
              function(e) {
                ...
                self1.displayName = self1.folderName;
          ...
          for (let b = 0; b < coll.length; b++) {
            coll[b].addEventListener(
              ...
              function(e) {
                ...
                self1.ganttOptions.title.text =
                  "Project Plan - <span style='font-size:15px'>" +
                  self1.folderName +
                  ":" +
                  this.innerText +
                  "</span>";
                self1.ganttOptions1.title.text =
                  "Project Plan - <span style='font-size:15px'>" +
                  self1.folderName +
                  ":" +
                  this.innerText +
                  "</span>";
                self1.displayName = self1.folderName + ":" + this.innerText;
                self1.summaryObj.summary = self1.getRelSummary(this.innerText);
                self1.summaryObj.defectSummary = self1.getRelDefectSummary(
                  this.innerText
                );
            ...
            coll[b].addEventListener("contextmenu", (e) => {
              ...
              let reltcfaDate = e.currentTarget.getAttribute(
                "data-reltcfaDate"
              );
              ...
              let franchise = e.currentTarget.getAttribute("data-franchise");
              let query_string = e.currentTarget.getAttribute(
                "data-query_string"
              );

              let relgisoDate = e.currentTarget.getAttribute(
                "data-relgisoDate"
              );
              let releotrDate = e.currentTarget.getAttribute(
                "data-releotrDate"
              );
              let folderName = e.currentTarget.getAttribute("data-folder");
              let resources = e.currentTarget.getAttribute("data-resources");
              let email_alias = e.currentTarget.getAttribute("data-email");
              let weekly_ReportFlag = e.currentTarget.getAttribute("data-weekly_ReportFlag");
              let robj = {
                ...
                weekly_ReportFlag:weekly_ReportFlag,
          ...
          if (self1.redirectToName === "") {
            coll[0].click();
          } else {
            let type = '';
            if(self1.redirectToType==='release'){
              type='folder'
            }
            else  if(self1.redirectToType==='project'){
              type='release'
            }
            let name = self1.redirectToName;
           if (type === "folder") {
              let clickflag = true;
              for (let f1 = 0; f1 < coll.length; f1++) {
                if (
                  coll[f1].getAttribute("data-folder") ===
                    self1.redirectToName &&
                  clickflag
                ) {
                  clickflag = false;
                  self1.folderName = self1.redirectToName;
                  self1.loadCustomersSummary(self1.folderName);
                  coll[f1].click();
                }
              }
            } else if(type==='release') {
              let clickflag = true;
              for (let ra = 0; ra < coll.length; ra++) {
                let rlName = self1.redirectToName.split("__");
                if (
                  coll[ra].innerText === rlName[0] &&
                  coll[ra].getAttribute("data-folder") === rlName[1] &&
                  clickflag
                ) {
                  self1.folderName = self1.redirectToName;
                  clickflag = false;
              ...
              if (!clickFlag) {
                for (let ra = 0; ra < coll.length; ra++) {
                  if (
                    coll[ra].getAttribute("data-folder") ===
                      self1.redirectToName &&
                    clickflag
                  ) {
                    clickflag = false;
              ...
              for (let s = 0; s < self1.releases.length; s++) {
                ...
                if (self1.selectedRelease === "") {
                  ...
                  self1.ganttOptions1.title.text =
                    ...
                    "</span>";
                  self1.displayName =
                    self1.folderName + ":" + self1.selectedReleaseName;
                  self1.summaryObj.summary = self1.getRelSummary(
                    self1.selectedReleaseName
                  );
                  self1.summaryObj.defectSummary = self1.getRelDefectSummary(
                    self1.selectedReleaseName
                ...
                let p_template ='';
                if(this.showFoldersList){
                   p_template =
                  '<div class="releaseContent"  id="release_' +
                  self1.releases[s].id +
                  '" style="display:block">';
                }
                else{
                ...
                for (let m = 0; m < pdata.length; m++) {
                  p_template +=
                    '<div class="r_projects" data-relId="' +
                    self1.releases[s].id +
                    '" data-relName="' +
                    self1.releases[s].name +
                    '" data-id="' +
                    pdata[m].id +
                    '" data-timsId="' +
                    pdata[m].tims_id +
                ...
                let prs = releaseDiv.nextSibling.getElementsByClassName(
                  "r_projects"
                );
                for (let z = 0; z < prs.length; z++) {
                  ...
                  prs[z].addEventListener("dblclick", function(e) {
                      self1.hideSidebar();
                       let folderName=event.currentTarget.parentElement.previousSibling.getAttribute('data-folder');
                    self1.folderName=folderName;
                    self1.proj_cust_Selected = false;
                     self1.hideSidebar();
                    self1.showTims = false;
                  ...
                  prs[z].addEventListener("contextmenu", function(e) {
                    ...
                    let pr_relName = e.currentTarget.getAttribute(
                      "data-relName"
                    );
    ...
    toggleScheme(scheme) {
      ...
      if (this.colorscheme != scheme) {
        ...
        if (scheme === "dark-scheme") {
          ...
          this.changeScheme(".r_chartDiv", "", "darkBackground");
          this.changeScheme(".b_chartDiv", "darkBackground", "lightBackground");
          this.changeScheme(".b_chartDiv", "", "darkBackground");
          this.changeScheme(
            ".b_chartDiv1",
            "darkBackground",
            "lightBackground"
          );
          this.changeScheme(".b_chartDiv1", "", "darkBackground");
          this.changeScheme(
            ".testcaseLineChart",
            "darkBackground",
            "lightBackground"
          );
          this.changeScheme(".testcaseLineChart", "", "darkBackground");
          this.changeScheme(
            ".defectChart",
            "darkBackground",
            "lightBackground"
          );
          this.changeScheme(".defectChart", "", "darkBackground");
          this.changeScheme(".cvtChart", "darkBackground", "lightBackground");
          this.changeScheme(".cvtChart", "", "darkBackground");

          for (let i = 0; i < temp.length; i++) {
            if (
              temp[i].parentElement.id === "chartB1Tabs" ||
              temp[i].parentElement.id === "chartB2Tabs"
            ) {
          ...
          for (let i = 0; i < temp1.length; i++) {
            if (
              temp1[i].parentElement.id === "chartB1Tabs" ||
              temp1[i].parentElement.id === "chartB2Tabs"
            ) {
          ...
          this.changeScheme(".r_chartDiv", "darkBackground", "darkBackground");
          this.changeScheme(".r_chartDiv", "", "lightBackground");
          this.changeScheme(".b_chartDiv", "darkBackground", "darkBackground");
          this.changeScheme(".b_chartDiv", "", "lightBackground");
          this.changeScheme(".b_chartDiv1", "darkBackground", "darkBackground");
          this.changeScheme(".b_chartDiv1", "", "lightBackground");
          this.changeScheme(
            ".testcaseLineChart",
            "darkBackground",
            "darkBackground"
          ...
          this.changeScheme(".defectChart", "darkBackground", "darkBackground");
          this.changeScheme(".defectChart", "", "lightBackground");
          this.changeScheme(".cvtChart", "darkBackground", "darkBackground");
    ...
    showChartPopup(options) {
      ...
      this.zoomChartOptions = JSON.parse(JSON.stringify(options));
    },
    showGanttChartPopup(options) {
      this.showGanttZoomChart = true;
      this.zoomGanttChartOptions = JSON.parse(JSON.stringify(options));
    },
    closeZoomChart() {
    ...
    closeGanttZoomChart() {
      this.showGanttZoomChart = false;
      this.zoomGanttChartOptions = {};
    },
    ...
    removeEvent: function() {
      ...
      testcaseService.deleteEvent(eventIds).then(
        ...
        (error) => {
          ...
          self.showErrorModal = true;
          if(error.message){
            self.loadingMessage = error.message;
          }
          else{
            self.modalErrorMessage =
      ...
      if (this.validateEventObj()) {
        ...
        testcaseService.createEvent([this.eventObj]).then(
          ...
          (error) => {
            ...
            if(error.message){
              self2.modalErrorMessage = error.message;
            }
            else{
    ...
    validateEventObj() {
      if (
        this.eventObj.event_type == "" ||
        this.eventObj.event_name == "" ||
        this.eventObj.event_name === undefined ||
        this.eventObj.event_name === null ||
        this.eventObj.event_start_date === null ||
        this.eventObj.event_start_date === undefined ||
        this.eventObj.event_start_date === "" ||
        this.eventObj.event_end_date === null ||
        this.eventObj.event_end_date === undefined ||
        this.eventObj.event_end_date === ""
      ) {
        return false;
      } else {
        return true;
    ...
    editReleaseBtnClicked: function(e){
      let relDiv=document.querySelector('#'+this.selectedRelease);
      if(relDiv){

         let temp = relDiv.getAttribute("data-orig");
              let timsId = relDiv.getAttribute("data-timsid");
              let custName = relDiv.getAttribute("data-custName");
              let attr = relDiv.getAttribute("data-attr");
              let relAttr = relDiv.getAttribute("data-relAttr");
              let relsDate = relDiv.getAttribute("data-relsDate");
              let reltcfaDate = relDiv.getAttribute(
                "data-reltcfaDate"
              );
              let relfcsDate = relDiv.getAttribute("data-relfcsDate");
              let relrSDate = relDiv.getAttribute("data-relrSDate");
              let relrEDate = relDiv.getAttribute("data-relrEDate");
              let rellSDate = relDiv.getAttribute("data-rellSDate");
              let rellEDate = relDiv.getAttribute("data-rellEDate");
              let franchise = relDiv.getAttribute("data-franchise");
              let query_string = relDiv.getAttribute(
                "data-query_string"
              );

              let relgisoDate = relDiv.getAttribute(
                "data-relgisoDate"
              );
              let releotrDate = relDiv.getAttribute(
                "data-releotrDate"
              );
              let folderName = relDiv.getAttribute("data-folder");
              let resources = relDiv.getAttribute("data-resources");
              let email_alias = relDiv.getAttribute("data-email");
              let weekly_ReportFlag = relDiv.getAttribute("data-weekly_ReportFlag");
              let robj = {
                rid: relDiv.id.substring(
                  relDiv.id.lastIndexOf("_") + 1
                ),
                rname: relDiv.innerText.split("\n")[0],
                rtimsid: timsId === "na" ? "" : timsId,
                rattribute: attr === "na" ? "" : attr, //temp[1],
                release_attribute: relAttr === "na" ? "" : relAttr,
                customerName: custName,
            ...
            this.editReleaseClicked(e,robj)
      }
              e.preventDefault();
    ...
    createReleaseClicked: function() {
      ...
      this.releaseObj = {
        retest_start_date: r_startDate,
        retest_end_date: r_endDate,
        franchise: "",
        query_string: "",
        longevity_start_date: l_startDate,
        longevity_end_date: l_endDate,
        giso_date: l_gisoDate,
        eotr_date: l_eotrDate,
      };
    },
    ...
    validateReleaseObj() {
      if (
        ...
        this.releaseObj.name === undefined ||
        this.releaseObj.name === null ||
        this.releaseObj.start_date === null ||
        this.releaseObj.start_date === undefined ||
        this.releaseObj.tcfa_date === null ||
        this.releaseObj.tcfa_date === undefined ||
        this.releaseObj.fcs_date === null ||
        this.releaseObj.fcs_date === undefined
      ) {
        return false;
      } else {
        return true;
        ...
        if (this.editRelease === false) {
          ...
          if (
            (releaseNames.length > 0 &&
              releaseNames.indexOf(releaseName) < 0) ||
            releaseNames.length <= 0
          ) {
          ...
          let releasestemplete = "";
          releasestemplete +=
            '<div class="collapsibleParent"><button type="button" class="collapsibleReleases activePR loaderRelease to-right"><span style="margin-left:10px">' +
            this.releaseObj.name +
            '</span><span class="loader1" style="float:right;margin-left:70px;"></span></button></div>';
...
<template>
<div>
  <Header1   v-on:child="onChildInteraction"></Header1>
  <div class="customerReleaseDiv" id="customerReleaseDiv">
  
   <!---- <div class="buttonsdiv">
      <button class="btn btn--secondary cm_addBtn" @click="showSidebar">
        <span
          v-tooltip.right="{
            html: 'showContent',
            class: 'cisco-tooltip',
      ...
      <button class="btn btn--primary cm_addBtn" @click="createReleaseClicked">
        <span
          v-tooltip.right="{
      ...
      >
        ...
        <div id="schemeContent">
          <ul style="list-style-type: none;">
            <li class="schemeli">
              <a @click="toggleScheme('dark-scheme')">Dark Scheme</a>
            </li>
            <li class="schemeli">
              <a @click="toggleScheme('light-scheme')">Light Scheme</a>
            </li>
            <li class="schemeli">
              <a @click="toggleScheme('default-scheme')">Default Scheme</a>
            </li>
          </ul>
        </div>
      </button>
      <button
        class="btn btn--primary cm_addBtn"
        @click="showCustGraphs = !showCustGraphs"
      >
        <span
          v-tooltip.right="{
            html: 'graphContent',
      ...
      <button class="btn btn--primary cm_addBtn" @click="mailBtnClicked">
        <span
          v-tooltip.right="{
            html: 'mailContent',
            class: 'cisco-tooltip',
      ...
      <button class="btn btn--primary cm_addBtn" @click="LandingPageClicked">
        <span
          v-tooltip.right="{
            html: 'landingContent',
            class: 'cisco-tooltip',
    ...
    <div class="mainDiv">
      <div class="releasesDiv hideReleaseDiv">
        <div class="releasesListDiv">
         <div class="releasesBtnlist row">
         <div class="showFolders">
          <input
                 type="checkbox"
                @click="showFoldersList=!showFoldersList"
                class="form-check-input showFolderbtn"
                />
         ...
         <!--  <div class="row modalLinks" v-show="!proj_cust_Selected">
          ...
          <div class="row modalLinks" v-show="proj_cust_Selected">
            <div class="mLinks">
              <a href="#" class="mlink" @click="execSummaryLinkClicked"
                >Exec Summary</a
              >
              <a href="#" class="mlink" @click="weeklyUpdateLinkClicked"
                >Weekly Update</a
              >
              <a href="#" class="mlink" @click="ahaLinkClicked">AHA</a>
              <a href="#" class="mlink" @click="cdetsLinkClicked">CDETS</a>
              <a href="#" class="mlink" @click="relLinkClicked">Release note</a>
              <a href="#" class="mlink" @click="automationLinkClicked"
                >Automation</a
              >
              <a href="#" class="mlink" @click="upgradeMtxLinkClicked"
                >Upgrade matrix
              </a>
              <a href="#" class="mlink" @click="triMtxLinkClicked"
                >Trigger matrix</a
              >
              <a href="#" class="mlink" @click="defectsLinkClicked">Quality</a>
            </div>
          </div>-->
        </div>
      </div>
      <div class="dashboardDiv">
        <div class="mainPage" v-if="!showExtraPage">
       <!---- -->
          <div>
            <div
              class="row custSummaryDiv"
              v-show="summary_customers.length > 0 && !showingMasterTcs"
            >
              <!-- <template v-for="(summary_obj,index) in summary_customers" > -->
            
              <splide
                :options="custSplideOptions"
                :slides="summary_customers"
                class="mySlides"
              >
                <splide-slide
                ...
                >
                  <div
                    class="summaryBox"
                    :key="index"
                    v-show="summary_obj.showSplide"
                  >
                    <div
                      :class="'custBox cust_box' + (index % 12)"
                      style="pointer:cursor;"
                      @click="
                        custBoxClicked(summary_obj.type, summary_obj)
                      "
                    >
                        ...
                        <div class="summaryData">
                          <div class="summaryData1">
                            <MiniChart
                              ...
                              :id="'chartGuage1_' + index"
                              :option="
                                JSON.stringify(summary_obj.execution1Options)
                              "
                            ></MiniChart>
                ...
                {{summary_obj.quality}}
                            ...
                            <MiniChart
                              class="chartSummary"
                              v-on:child="onChildInteraction"
                              :id="'chartGuage2_' + index"
                              :option="
                                JSON.stringify(summary_obj.qualityOptions)
                              "
                            ></MiniChart>
                            <div class="circleBoxdata">
                              Quality
                        ...
                        <div class="summaryChart">
                          <div class="summaryButtonCharts">
                            <MiniChart
                              class="chartSummary"
                              v-on:child="onChildInteraction"
                              :id="'chartSummary_' + index"
                              :option="
                                JSON.stringify(summary_obj.executionOptions)
                              "
                            ></MiniChart>
                          </div>
                        </div>
          ...
          <div >
            <div class="row releaseSummaryDiv darkBg" v-show="showCustGraphs && !showingMasterTcs">
                    ...
                    <div class="contentGraph">
                      <div v-show="!showProjectPlanForm">
                        <GanttChart
                          ...
                          v-on:child="onChildInteraction"
                          id="timeLineChart"
                          v-show="!ganttOptionFlag"
                          :colorscheme="colorscheme"
                          :option="ganttOptions1"
                          toggleTableOption="showProjectPlanForm"
                          toggleOption="ganttOptionFlag"
                        ></GanttChart>
                        <GanttChart
                          disbleExport="false"
                          v-on:child="onChildInteraction"
                      ...
                      <div v-show="showProjectPlanForm">
                        ...
                        <form class="projectPlanForm">
                          ...
                          <div
                            class="form-group tm-form-group1 row releaseDatesContainer"
                          >
                            <div class="projectField">
                              <div
                                class="form-group__text tm-form__text projectDateField"
                          ...
                          >
                            ...
                            <div class="projectField">
                              ...
                              >
                                ...
                                <date-picker
                                  v-model="
                                    releaseDetails1.actual_retest_start_date
                                  "
                                  @change="addDateRack"
                                  :format="format"
                                  value-type="format"
                            ...
                            <div class="projectField">
                              ...
                              >
                                ...
                                <date-picker
                                  v-model="
                                    releaseDetails1.actual_retest_end_date
                                  "
                                  @change="addDateRack"
                                  :format="format"
                                  value-type="format"
                            ...
                            <div class="projectField">
                              ...
                              >
                                ...
                                <date-picker
                                  v-model="
                                    releaseDetails1.actual_longevity_start_date
                                  "
                                  @change="addDateRack"
                                  :format="format"
                                  value-type="format"
                            ...
                            <div class="projectField">
                              ...
                              >
                                ...
                                <date-picker
                                  v-model="
                                    releaseDetails1.actual_longevity_end_date
                                  "
                                  @change="addDateRack"
                                  :format="format"
                                  value-type="format"
          ...
          <div class="radioTypes" style="padding-left:20px;">
            <input @change="applyChangeFunc" type="radio" name="applyChangesTo" value="customer" v-model="applyChangesTo"><label for="customer" style="padding:10px">Customer</label>
             ...
             <input @change="applyChangeFunc" type="radio" name="applyChangesTo" value="project"  v-model="applyChangesTo"><label for="project" style="padding:10px">Project</label>
                      ...
                      <div
                        id="buttonGroup"
                        class="button-row"
                        v-if="ganttOptionFlag"
                      >
                        <button
                          class="btn btn--primary addEventBtn"
                          id="btnShowDialog"
            ...
            <div class="row releaseSummaryDiv1" v-show="showCustGraphs && !showingMasterTcs">
              <div class="col-lg-12 col-md-12">
                <div class="belowCharts row belowChartsLight">
                    ...
                    <div class="r_chartDiv aa darkBackground">
                      <div class="summaryCharts">
                        <chart
                          ...
                          id="chart_a1"
                          class="chartsA"
                          v-show="!showExecutionPie"
                          :option="executionSummaryOption"
                          toggleOption="showExecutionPie"
                        ></chart>
                        <chart
                          disbleExport="false"
                          v-on:child="onChildInteraction"
                          ...
                          class="chartsA"
                          v-show="showExecutionPie"
                          :option="executionSummaryOption1"
                          toggleOption="showExecutionPie"
                        ></chart>
                      </div>
                      <div class="summary_Data">
                        <div class="projectedSummaryData">
                          ...
                          <div class="summary_li darkBg">
                            ...
                            >
                              {{
                                summaryButtonsDetails.testcasesExecuted
                                  .percentage
                              }}%
                            </div>
                            <div class="coloredCircleBoxdata">
                          ...
                          <div class="summary_li darkBg">
                            <div
                              v-if="!showExecutionPie"
                              :class="
                                'summaryCircle2  coloredCircleBorder ' +
                                  getColorClassForQuality(
                                    summaryButtonsDetails.resultQuality
                                      .resultQuality
                                  )
                              "
                            >
                            ...
                            <div
                              v-else
                              class="summaryCircle2  coloredCircleBorder coloredBorder3"
                            >
                              {{
                                summaryButtonsDetails.resultQuality
                                  .projectedResultQuality
                              }}%
                            </div>
                            <div
                  ...
                  <div class="testcaseLineChart darkBackground width36Per">
                    <chart
                      disbleExport="false"
                      :colorscheme="colorscheme"
                      v-show="!showSplineDataTable"
                      v-on:child="onChildInteraction"
                      id="splineChart"
                      :option="splineOptions"
                      toggleTableOption="showSplineDataTable"
                    ></chart>
                    <div
                      v-show="showSplineDataTable"
                      class="weeklyExecutionTable darkBg"
                    >
                      <button
                        class="btn btn--primary tableGrphBtn"
                      ...
                      <div class="weeklyExecTable1">
                        <table
                          class="weeklyExecTable table--highlight secondaryTable"
                        >
                          <tr>
                            <th>
                              Week
                            ...
                            <tr v-if="editingRow" :key="index + 'a'">
                              ...
                              <td>
                                <input
                                  type="text"
                                  class="weeklyTableText"
                                  v-model="w_obj.software_version"
                                />
                              </td>
                            </tr>
                          </template>
            ...
            <div class="secondPage secondPageLight" v-show="showCustGraphs && !showingMasterTcs">
              <div class="belowCharts1 row belowCharts1Default">
                <div class="width40Per">
                  <div class="defectChart darkBackground">
                    <div class="cvtChart" v-show="!showCVTDataTable">
                      <chart
                        ...
                        id="cvtChart"
                        :option="cvtOptions"
                        toggleTableOption="showCVTDataTable"
                      ></chart>
                    </div>
                    <div class="cvtData" v-show="!showCVTDataTable">
                      <div class="projectedSummaryData">
                        <div class="summary_li1 darkBg">
                            ...
                            <tr v-if="editing1Row" :key="index + 'a'">
                              <td>
                                <input
                                  type="text"
                                  class="weeklyTableText"
                                  :value="getFilteredDate(w_obj.end_date)"
                                  readonly="true"
                                />
                              </td>
                              <td>
                              ...
                              <td>
                                <input
                                  type="text"
                                  class="weeklyTableText"
                                  v-model="w_obj.planned_ddts_count"
                                />
                              </td>
                              <td>
                                <input
                                  type="text"
                                  class="weeklyTableText"
                                  v-model="w_obj.defects_found_CVT"
                                />
                              </td>
                              <td>
                                <input
                                  type="text"
                                  class="weeklyTableText"
                                  v-model="w_obj.defects_observed"
                                />
                              </td>
                              <td>
                                <input
                                  type="text"
                                  class="weeklyTableText"
                                  v-model="w_obj.must_have_defects"
                                />
                              </td>
                            </tr>
                          </template>
                ...
                <div class="width30Per">
                  <div class="b_chartDiv  darkBackground aa">
                  ...
                  <div class="b_chartDiv  darkBackground aa">
                    <tabs
                      ...
                      :options="{
                        ...
                        defaultTabHash: 'componentTab',
                      }"
                      @clicked="defectTabClicked"
                      @changed="defectTabClicked"
                    >
                      <tab
                        name="Component"
                        id="defectComponentChart"
                        class="darkBg"
                        ref="componentTab"
                      >
                        <chart
                          v-show="componentWithFilterFlag"
                          disbleExport="false"
                          :colorscheme="colorscheme"
                          v-on:child="onChildInteraction"
                          id="chart8a"
                          :option="componentWithFilterOption"
                          toggleOption="componentWithFilterFlag"
                        ></chart>
                      ...
                      <tab name="Status" id="defectStatusChart" ref="statusTab">
                        <chart
                          v-show="statusWithFilterFlag"
                          disbleExport="false"
                          :colorscheme="colorscheme"
                          v-on:child="onChildInteraction"
                          id="chart9a"
                          :option="statusWithFilterOption"
                          toggleOption="statusWithFilterFlag"
                        ></chart>
                        <chart
                          v-show="!statusWithFilterFlag"
                          disbleExport="false"
                      ...
                      <tab
                        name="Submitter"
                        id="defectSubmitterChart"
                        ref="submitterTab"
                      >
                        <chart
                          v-show="submitterWithFilterFlag"
                          disbleExport="false"
                          :colorscheme="colorscheme"
                          v-on:child="onChildInteraction"
                          id="chart7a"
                          :option="submitterWithFilterOption"
                          toggleOption="submitterWithFilterFlag"
                        ></chart>
                        <chart
                          v-show="!submitterWithFilterFlag"
                          disbleExport="false"
              ...
              <div class="row belowCharts1 belowCharts1Default">
                <div class="width35Per">
                  <div class="b_chartDiv  darkBackground ">
                    <tabs
                      id="chartB1Tabs"
                      name="chartB1Tabs"
                      :options="{
                    ...
                    >
                      ...
                      <tab
                        ...
                        class="qualityPlatformChart darkBg"
                        ref="Platform"
                      >
                        <chart
                          disbleExport="false"
                      ...
                      <tab
                        ...
                        class="qualityFeatureChart darkBg"
                        ref="Feature"
                      >
                        <chart
                          disbleExport="false"
                ...
                <div class="width30Per">
                  <div class="defectChart darkBackground">
                    ...
                    >
                      ...
                      <tab
                        name="TC Trend"
                        id="userTestcasesChart"
                        class="userTestcasesChart darkBg"
                        ref="users_Tcs"
                      >
                        <chart
                          disbleExport="false"
                          ...
                          v-on:child="onChildInteraction"
                          id="chart_a33"
                          :option="userHeatMapOptions1"
                        ></chart>
                      </tab>
                      <tab
                        name="Defect Trend"
                        id="userDefectsChart"
                        class="userDefectsChart darkBg"
                        ref="users_Defects"
                      >
                        <chart
                          disbleExport="false"
          ...
          <div>
            ...
            <UniqueTestcaseCharts
              v-if="showingUniqueCharts && !showingMasterTcs"
              :colorscheme="colorscheme"
            ...
            <div class="row" v-show="!showingMasterTcs">
              <div class="slidesBtn">
                <div class="slideBtnGroup row" style="width:30%">
                <div class="slideBtnGroupTitle">Execution</div>
                <div class="slideBtnDetailElm slideBtnDetailElm1 row">
                  <span class="slideBtnDetailName">Executed</span>
                <span class="slideBtnDetailCount">  {{ summaryButtonsDetails.testcasesExecuted.percentage }}%</span>
                </div>

                 <div class="slideBtnDetailElm slideBtnDetailElm1 row">
                   <span class="slideBtnDetailName">Quality</span>
                <span class="slideBtnDetailCount"> {{ summaryButtonsDetails.resultQuality.resultQuality }}%</span>
                </div>

                <div class="slideBtnDetailElm  slideBtnDetailElm1 row">
                  <span class="slideBtnDetailName">Passed</span>
                <span class="slideBtnDetailCount">{{ summaryButtonsDetails.testcasesPassed.percentage }}%</span>
                </div>

                 <div class="slideBtnDetailElm slideBtnDetailElm1 row">
                   <span class="slideBtnDetailName">Defects</span>
                <span class="slideBtnDetailCount">   {{ summaryButtonsDetails.totalDefects }}</span>
                </div>

                 <div class="slideBtnDetailElm slideBtnDetailElm1 row">
                   <span class="slideBtnDetailName">Pending</span>
                              <span class="slideBtnDetailCount">  {{ summaryButtonsDetails.testcasesPending.percentage }}</span>
                </div>

                <div class="slideBtnDetailElm slideBtnDetailElm1 row">
                  <span class="slideBtnDetailName">Must Haves</span>
                <span class="slideBtnDetailCount"> {{ mhDefectsCount }}</span>
                </div>

                
                 <!-- <button
                    class="r_summaryDiv c_executionSummary"
                    v-tooltip.right="{
                  ...
                  >
                    <div class="totalCount">
                      {{ summaryButtonsDetails.testcasesPending.percentage }}%
                    </div>
                    <div class="summaryname">Pending</div>
                    <div id="showPending">
                      {{ summaryButtonsDetails.testcasesPending.count }}
                    </div>
                  </button>
                  <button
                    class="r_summaryDiv c_qualitySummary"
                    :style="
                      'background:' +
                        getColorForPerc(
                          summaryButtonsDetails.testcasesExecuted.percentage,
                ...
                <div class="slideBtnGroup row" style="width:30%">
                <div class="slideBtnGroupTitle">Test Plan</div>
                <div class="slideBtnDetailElm slideBtnDetailElm2 row">
                  <span class="slideBtnDetailName">Testcases</span>
                <span class="slideBtnDetailCount"><a   @click="loadActualTestcases()"> {{ summaryButtonsDetails.totalTestcases }}</a></span>
               </div>

                 <div class="slideBtnDetailElm slideBtnDetailElm2 row">
                    <span class="slideBtnDetailName">Unique Testcases</span>
                            <span class="slideBtnDetailCount"><a @click="loadUniqueTcs()">  {{ summaryButtonsDetails.unique_testcases }}</a></span>
                 </div>

                <div class="slideBtnDetailElm slideBtnDetailElm2 row">
                  <span class="slideBtnDetailName">Platforms</span>
                <span class="slideBtnDetailCount">  {{ summaryButtonsDetails.totalPlatforms }}</span>
                </div>

                 <div class="slideBtnDetailElm slideBtnDetailElm2 row">
                  <span class="slideBtnDetailName">Roles</span>
                <span class="slideBtnDetailCount">   {{ summaryButtonsDetails.totalRoles }}</span>
                 </div>

                 <div class="slideBtnDetailElm slideBtnDetailElm2 row">
                     <span class="slideBtnDetailName">New Features</span>
                <span class="slideBtnDetailCount">  {{ ahaList.length }}</span>
                </div>

                <div class="slideBtnDetailElm slideBtnDetailElm2 row">
                  <span class="slideBtnDetailName">CFDs</span>
                <span class="slideBtnDetailCount"><a  @click="showSummary('CFDs')">{{ summaryButtonsDetails.totalCFD }}</a></span>
                </div>
                 <!-- <button
                    class="r_summaryDiv c_testcases"
                    @click="loadActualTestcases()"
                  >
                    <div class="totalCount">
                      {{ summaryButtonsDetails.totalTestcases }}
                    </div>
                  ...
                  <button class="r_summaryDiv c_unique" @click="loadUniqueTcs">
                    <div class="totalCount">
                      {{ summaryButtonsDetails.unique_testcases }}
                    </div>
                    <div class="">Uni TCs</div>
                  </button>
                  <button v-if="!showingUnique" class="r_summaryDiv c_duration">
                    <div class="totalCount">
                      {{ summaryButtonsDetails.totalAutomatedTestcases }}
                    </div>
                    <div class="summaryname">Automated</div>
                  </button>
                  <button v-if="showingUnique" class="r_summaryDiv c_duration">
                    <div class="totalCount">
                      {{ totalUniqueAutomatedTestcases }}
                    </div>
                    <div class="summaryname">Uniq Auto</div>
                  </button>

                  <button class="r_summaryDiv c_smoke">
                    <div class="totalCount">0</div>
                    <div class="summaryname">Somke</div>
                  </button>

                  <button
                    class="r_summaryDiv c_cfd"
                    @click="showSummary('CFDs')"
                  >
                    <div class="totalCount">
                      {{ summaryButtonsDetails.totalCFD }}
                    </div>
                    <div class="summaryname">CFDs</div>
                  </button>-->
                </div>
                <div class="slideBtnGroup row" style="width:30%">
                 <div class="slideBtnGroupTitle">Automation</div>
                <div class="slideBtnDetailElm slideBtnDetailElm3 row">
                  <span class="slideBtnDetailName">Automatable</span>
                <span class="slideBtnDetailCount">  {{ summaryButtonsDetails.Automatable.Yes }}</span>
                </div>

                 <div class="slideBtnDetailElm slideBtnDetailElm3 row">
                   <span class="slideBtnDetailName">Automated</span>
                <span class="slideBtnDetailCount">  {{ summaryButtonsDetails.totalAutomatedTestcases }}</span>
                </div>

                <div class="slideBtnDetailElm slideBtnDetailElm3 row">
                 <span class="slideBtnDetailName">Empty Procedures</span>
                <span class="slideBtnDetailCount"><a  @click="loadEmptyProcTcs">    {{ summaryButtonsDetails.emptyProcedure }}</a></span>
                 </div>

                 <div class="slideBtnDetailElm slideBtnDetailElm3 row">
                  <span class="slideBtnDetailName">Unique Automated</span>
                <span class="slideBtnDetailCount">     {{ totalUniqueAutomatedTestcases }}</span>
                </div>

                 <div class="slideBtnDetailElm slideBtnDetailElm3 row">
                 <span class="slideBtnDetailName">Auto Logs</span>
                <span class="slideBtnDetailCount">  {{ summaryButtonsDetails.logDetails.Automation }}</span>
                 </div>

                <div class="slideBtnDetailElm slideBtnDetailElm3 row">
                 <span class="slideBtnDetailName">Manual Logs</span>
                <span class="slideBtnDetailCount">{{ summaryButtonsDetails.logDetails.Manual }}</span>
                </div>
                 <!---- <button
                    ...
                    @click="
                      showSummaryDetails(
                        'Platforms',
                        summaryButtonsDetails.platform
                      )
                    "
                  >
                    <div class="totalCount">
                      {{ summaryButtonsDetails.totalPlatforms }}
                    </div>
                  ...
                  <button
                    ...
                    @click="
                      showSummaryDetails('Roles', summaryButtonsDetails.role)
                    "
                  >
                    <div class="totalCount">
                      {{ summaryButtonsDetails.totalRoles }}
                    </div>
              ...
              >
                ...
                <div class="summaryname">Features</div>
                  ...
                  <button
                    class="r_summaryDiv c_logs"
                    @click="loadWithLogTcs"
                    v-tooltip.right="{
                  ...
                  >
                    <div class="totalCount">
                      {{ summaryButtonsDetails.logDetails.totalLogs }}
                    </div>
                    <div class="summaryname">Logs</div>
                    <div id="showManualLogsCount">
                      <div>
                        Manual: {{ summaryButtonsDetails.logDetails.Manual }}
                      </div>
                      <div>
                        Automation:
                        {{ summaryButtonsDetails.logDetails.Automation }}
                      </div>
                    </div>
                  </button>
                  <button
                    class="r_summaryDiv c_noProcedure"
                    @click="loadEmptyProcTcs"
                  >
                    <div class="totalCount">
                      {{ summaryButtonsDetails.emptyProcedure }}
                    </div>
                    <div
                      class="summaryname"
            ...
            <TestcaseList
              ...
              :summaryButtonsDetails="summaryButtonsDetails"
              :uniqueTestcaseDetails="uniqueTestcaseDetails"
              :emptyProcedureTestcaseDetails="emptyProcedureTestcaseDetails"
              :withLogTestcaseDetails="withLogTestcaseDetails"
              ...
              :heatMapOptions="heatMapOptions1"
              :showingUnique="showingUnique"
              :showingActual="showingActual"
              :showingMasterTcs="showingMasterTcs"
              :showingWithLogs="showingWithLogs"
              :showingEmptyProc="showingEmptyProc"
              v-on:child="onChildInteraction"
            ></TestcaseList>
        ...
        <div class="extraPage" v-if="showExtraPage">
          <div v-if="showExecSummaryModal" class="extraPage">
            <ExecutionSummaryTable
              :displayName="displayName"
              :customerName="customerName"
              :releaseId="selectedRelId"
              ...
              :mhDefectsCount="mhDefectsCount"
              :mainCdets="mainCdets"
              :execrelName="execrelName"
              :execProjects="execProjects"
              :showExtraPage="showExtraPage"
              v-on:child="onChildInteraction"
            >
            </ExecutionSummaryTable>
          </div>
          <div v-if="showRelModal" class="extraPage">
            <ReleaseNoteWeeklyReport
              :displayName="displayName"
              :customerName="customerName"
              :releaseId="selectedRelId"
          ...
          <div v-if="showWeeklyUpdateModal" class="extraPage">
            <WeeklyUpdatePage
              :displayName="displayName"
              :weeklyReportFlag="weeklyReportFlag"
              :releaseId="selectedRelId"
              :customerName="selectedCustomerName"
              :folderName="folderName"
              :weeklyReport="weeklyReport"
              :custTotalReleases="custTotalReleases"
              :custSelectedReleases="custSelectedReleases"
              :showExtraPage="showExtraPage"
              v-on:child="onChildInteraction"
            >
            </WeeklyUpdatePage>
          </div>
          <div v-if="showAhaModal" class="extraPage">
            <AhaListPage
              :displayName="displayName"
              :weeklyReportFlag="weeklyReportFlag"
              :releaseId="selectedRelId"
          ...
          <div v-if="showCdetsModal" class="extraPage">
            <CdetsListPage
              :selectedCdets="selectedCdets"
              :showExtraPage="showExtraPage"
              v-on:child="onChildInteraction"
            >
            </CdetsListPage>
          </div>
          <div v-if="showUpgradeMatrixModal" class="extraPage">
            <UpgradeMatrixTable
              :displayName="displayName"
              :weeklyReportFlag="weeklyReportFlag"
              :releaseId="selectedRelId"
          ...
          <div v-if="showTriggerMatrixModal" class="extraPage">
            <TriggerMatrixTable
              :displayName="displayName"
              :weeklyReportFlag="weeklyReportFlag"
              :releaseId="selectedRelId"
          ...
          <div v-if="showDefectModal" class="extraPage">
            <DefectsDetails
              :releases="releases"
              :showExtraPage="showExtraPage"
              :testcases="testcases"
    ...
    <div class="context_modals">
      <ContextMenu ref="fmenu" class="fmenu">
        <template slot-scope="{ contextData }">
          ...
          <ContextMenuItem @click.native="cloneReleaseClicked(contextData)">
            Clone Release
          </ContextMenuItem>
        </template>
      </ContextMenu>
      <ContextMenu ref="rmenu" class="rmenu">
        <template slot-scope="{ contextData }">
          <ContextMenuItem
            @click.native="createProjectClicked($event, contextData)"
          >
            Create Folder
          </ContextMenuItem>
          <ContextMenuItem
            @click.native="cloneProjectClicked($event, contextData)"
          >
            Clone Project
          </ContextMenuItem>
          <ContextMenuItem
            @click.native="editReleaseClicked($event, contextData)"
          >
            Edit Project
          </ContextMenuItem>
          ...
          <ContextMenuItem
            @click.native="relSyncBtnClicked($event, contextData)"
          >
            Sync from Tims
          </ContextMenuItem>
          <ContextMenuItem
            @click.native="uploadRelSyncBtnClicked($event, contextData)"
          >
            Upload to Tims
          </ContextMenuItem>
          <ContextMenuItem
            @click.native="updateCdetsRelBtnClicked($event, contextData)"
          >
            Update Cdets
          </ContextMenuItem>
        </template>
      ...
      <ContextMenu ref="schememenu" class="schememenu">
        ...
        <ContextMenu ref="deleteUser" class="deletemenu">
        <template slot-scope="{ contextData }">
          <ContextMenuItem @click.native="deleteUserClicked($event,contextData)">
            Delete User
          </ContextMenuItem>
        </template>
      </ContextMenu>
      ...
      <ContextMenu ref="pmenu" class="pmenu">
        <template slot-scope="{ contextData }">
          ...
          <ContextMenuItem @click.native="deleteProjectClicked($event, contextData)">
            Delete Folder
          </ContextMenuItem>
          ...
          <ContextMenuItem
            @click.native="uploadPrSyncBtnClicked($event, contextData)"
          >
            Upload to Tims
          </ContextMenuItem>
        </template>
        ...
        <form class="create_event">
          ...
          <div class="form-group__text tm-form__text">
            ...
            <input
              ...
              list="eventTypes"
              style="width: 100%;"
              v-model="eventObj.event_type"
            />
            <datalist id="eventTypes" style="width: 100%;">
    ...
    <div v-if="showZoomChart" class="zoomChartModal">
      <div class="modal__body" style="display:flex; justify-content:center;">
        <span
          class="icon-close icon-small interaction closeBtn"
        ...
        <chart
          ...
          id="zoomChart"
          class="zoomChart"
          :option="zoomChartOptions"
        ></chart>
      </div>
    </div>
    <div v-if="showGanttZoomChart" class="zoomChartModal">
      <div class="modal__body" style="display:flex; justify-content:center;">
        <span
          class="icon-close icon-small interaction closeBtn"
          v-on:click="closeGanttZoomChart()"
        ></span>
        <GanttChart
          disbleExport="false"
          id="zoomGanttChart"
          class="zoomChart"
          :option="zoomGanttChartOptions"
        ></GanttChart>
      </div>
    </div>
            ...
            <div style="width:10%">
              <div class="form-group__text tm-form__text">
                ...
                <datalist id="folders" style="width: 100%;">
                  <option
                    v-for="(folder_name, index) in folders"
                    :key="index"
                    >{{ folder_name }}</option
                  >
                </datalist>
          ...
          <div class="form-group tm-form-group1 row" style="width:100%">
            <div style="width:40%">
              ...
              <div class="form-group__text tm-form__text">
                ...
                <input
                  type="text"
                  v-model="releaseObj.email_alias"
                  style="width: 100%;"
                />
                <!--<select v-model="seletedUsers"  @change="onUserChange($event)"  multiple>
              <option v-for="(user1, index1) in userSummary" :key="index1" :value="user1.name">{{
             ...
             <div style="width:10%">
              <div class="form-group__text tm-form__text">
                ...
                <label class="switch">
                <input type="checkbox" class="form-check-input" id="toggleBtn" v-model="releaseObj.weekly_ReportFlag" 
                  >
    ...
    <div v-if="showCreateProjectModal" class="createCustomerModal">
     ...
     <div v-if="showUserModal" class="userModal">
      <div
        class="modal__header sticky-top"
        style="display:flex; justify-content:space-between; margin-bottom:5px;"
      >
      ...
      <div class="modal__body" style="display:flex; justify-content:center;">
        ...
        <div class="userHeading" style="margin-top:20px">
           <h4>
            <a @click="createtokenforothers($event)">
              Manage Token
              </a> 
                </h4>
        </div>
        ...
        <div class="userFunctions">
          <ul class="userList" v-if ="isUserClicked" >
            <li class="userfunc" v-if="isAdmin && isUserAdmin" >
              <a  @click="updatePasswordToken($event)">Change Password</a>
              </li>
            ...
            <li class="userfunc">
              <a @click="createtokenforothers($event)">Create Token</a>
            </li>
          </ul>
          ...
          <!-- Create Token for others -->
          <div class="tokenBlk" v-if="showCreateToken">
            <div style="color:#005073;font-weight:bold;">
              <h5>{{userTitle}}</h5>
            </div>
            <form
    ...
    margin-top: 20px;"
            >
              <div
                ...
                style="width:100%;display:inline-block;position:relative;margin-bottom: 10px"
              >
                <label class="tm-label" style="width:30%">
                  UserName
                ...
                <input type="text"
                  style="width:60%"
                   v-model="newUser.username"
                   @focus="newUser.username ='' "
                   autocomplete="off"
                   @change="nestedObject($event)"
                   list="userList"/>
                  <datalist
                  id="userList"
                   class="username"
                   style="width: 60%;height:24px;"
                    >
                    <option v-for="(user, index) in userList.userDetails" :key="index" >{{user.name}} </option>
                  </datalist>
              ...
              >
                <label class="tm-label" style="width:30%">
                  ...
                  id="userToken"
                   ...
                   style="width: 60%;height:24px;"
                    >
                     <option v-for="(token, index1) in userObj.token" :key="index1" :value="token.tokenid"> {{token.tokenid}}</option>
                  </datalist>
              ...
              >
                <label class="tm-label" style="width:30%">
                 ...
                 <input type="text"
                  style="width:60%"
                  id="DBname"
                   @focus="newUser.databaseName ='' "
                   autocomplete="off"
                   v-model="newUser.databaseName"
                   @change="dbNameChanged($event)"
                   list="userDatabase" />
                  ...
                  id="userDatabase"
                   ...
                   style="width: 60%;height:24px;"
                    >
                     <option v-for="(token, index2) in userObj.token" :key="index2" :value="token.DBname"> {{token.DBname}}</option>
                  </datalist>
            ...
            <option  value=""> </option>
              ...
              <span style="font-size: 11px;color: #017cad;"
                ...
                <div class="tm_btn-container" style="margin-top:10px;margin-right:50px">
                <button
                  class="btn btn--secondary tmBtn"
          ...
          <!-- end Create Token for Others -->

              <!-- Update Password -->
          <div class="updatePasswordBlk" v-if="showPasswordChange">
            <div style="color:#005073;font-weight:bold;">
              <h5>{{userTitle}}</h5>
            </div>
            <form
          ...
          <div
           ...
           <div
              ...
              >
                ...
                <button
                  class="btn btn--secondary tmBtn"
                  @click="closePasswordUpdate($event)"
                  style="font-size:1.4rem;"
                >
                  Cancel
                </button>
                <button
                 @click="updatePasswordClicked($event)"
                  class="tmBtn btn btn--secondary"
                  style="font-size:1.4rem;"  
                >
                  Submit
        ...
        <div v-if="isAdmin" style="margin-top: 30px;">
          ...
          <div class="allUsers">
            <div
              ...
              v-for="(user, index) in userList.Administrators"
              :key="index"
              @click ="nestedObject($event)"
              >
              ...
              <img
                ...
                @contextmenu.prevent="$refs.deleteUser.open($event, user)"
          ...
          <div class="allUsers">
            <div
              class="userObj"
              style="width: 110px;display:inline-block;text-align: center;"
              v-for="(user, index) in userList.members"
              :key="index"
              @click ="nestedObject($event)" 
            >
    ...
    <div v-if="showCFDSummaryInfoModal" class="cfdSummaryDisplayModal">
      ...
      <div class="modal__body" style="display:flex; justify-content:center;">
        <table class="table table--highlight secondaryTable">
          <tr>
            <th style="text-align: left;">{{ summaryInfoTitle }}</th>
            <th style="text-align: left;">Count</th>
            <th style="text-align: left;">Testcases</th>
            <th style="text-align: left;">Component</th>
            <th style="text-align: left;" v-if="summaryInfoTitle === 'CFDs'">
              Product
            </th>
            <th style="text-align: left;" v-if="summaryInfoTitle === 'Defects'">
              Status
            </th>
            <th style="text-align: left;white-space:pre-wrap;width:25%">
              Headline
            </th>
          </tr>
          <tr
          ...
          >
            ...
            <td style="text-align: left;">
              <template v-for="(str, index1) in item.testcaseId"
                ><span :key="index1" v-if="index1 > 0">,</span
                ><a
                  style="margin-left: 5px;"
                  :key="'a' + index1"
                  @click="openTestcase(str)"
                  >{{ str }}</a
                ></template
              >
            </td>
            ...
            <td
              ...
              v-if="summaryInfoTitle === 'CFDs'"
            >
              {{ item.product }}
            </td>
            <td
              style="text-align: left;white-space:pre-wrap;"
              v-if="summaryInfoTitle === 'Defects'"
            >
              {{ item.status }}
            </td>
            <td style="text-align: left;white-space:pre-wrap;width:25%">
              {{ item.headline }}
            </td>
          </tr>
        </table>
    ...
    <div v-if="showRelModal && !showExtraPage" class="execSummaryModal">
      <ReleaseNoteWeeklyReport
        :displayName="displayName"
        :customerName="customerName"
        :releaseId="selectedRelId"
    ...
    <div
      v-if="showWeeklyUpdateModal && !showExtraPage"
      class="execSummaryModal"
    >
      <WeeklyUpdatePage
        :displayName="displayName"
        :weeklyReportFlag="weeklyReportFlag"
    ...
    <div v-if="showAhaModal && !showExtraPage" class="execSummaryModal">
      <AhaListPage
        :displayName="displayName"
        :weeklyReportFlag="weeklyReportFlag"
        :releaseId="selectedRelId"
    ...
    <div v-if="showCdetsModal && !showExtraPage" class="execSummaryModal">
      <CdetsListPage
        :selectedCdets="selectedCdets"
        :showExtraPage="showExtraPage"
        v-on:child="onChildInteraction"
    ...
    <div v-if="showExecSummaryModal && !showExtraPage" class="execSummaryModal">
      <ExecutionSummaryTable
        :displayName="displayName"
        :customerName="customerName"
        :releaseId="selectedRelId"
    ...
    <div v-if="showSampleMailModal" class="execSummaryModal">
      <MailSamplePage
        :releases="releases"
    ...
    <div
      v-if="showUpgradeMatrixModal && !showExtraPage"
      class="upgradeMatrixModal"
    >
      <UpgradeMatrixTable
        :displayName="displayName"
        :weeklyReportFlag="weeklyReportFlag"
    ...
    <div
      v-if="showTriggerMatrixModal && !showExtraPage"
      class="triggerMatrixModal"
    >
      <TriggerMatrixTable
        :displayName="displayName"
        :weeklyReportFlag="weeklyReportFlag"
    ...
    <div v-if="showMenuBarFlag" class="rightMenubar">
       <div class="row modalLinks" v-show="proj_cust_Selected">
              <div class="mLinks">
               <a href="#" class="mlink" @click="createReleaseClicked"
                >Create Project</a
              >
              <a href="#" class="mlink" @click="editReleaseBtnClicked"
                >Edit Project</a
              >
              </div>
            <div class="mLinks">
              ...
              ><strong>{{ currentUser }}</strong>
               ...
               <a v-if="currentUser" @click="logoutClicked($event)"
    ...
    <div v-if="showDefectModal && !showExtraPage" class="defectModal">
      <DefectsDetails
        :releases="releases"
        :showExtraPage="showExtraPage"
        :testcases="testcases"
    ...
    <div v-if="showCFDModal" class="CFDTableModal">
      ...
      <div
        class="modal__body"
        style="display:block !important; justify-content:center;margin: 10px;margin-top:0 !important;margin-left: 5px;"
      >
        <div style="width:98%;">
          <tabs
            ...
            <template v-for="(custRelease, index) in custReleaseArray">
              ...
              >
                <div style="text-align: right;">
                  <button
                    class="btn btn--primary cm_addBtn_1"
                    @click="addCFDClicked"
                  >
                    <span>
                      <i class="icon icon-plus"> </i>
                ...
                <table class="table table--highlight secondaryTable">
                  ...
                  <template v-if="addCFD">
                    <tr>
                      <td
                        style="text-align: left;width:12%;margin-left:5px;"
                      ></td>
                    ...
                    <tr>
                      ...
                      <td style="text-align: left;width:11%;margin-left:5px;">
                        <input
                          ...
                          v-model="addCFDObj.customer_release"
                        />
                      </td>
                      <td style="text-align: left;width:11%;margin-left:5px;">
                        <input
                      ...
                      <td style="text-align: left;width:11%;margin-left:5px;">
                        <input
                          type="text"
                          name="GISO_Version"
                          v-model="addCFDObj.GISO_Version"
                        />
                      </td>
