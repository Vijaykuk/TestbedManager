...
//user chart
  ...
  //defect testcase user chart
    ...
    getRelSummary(relname){
      for(let i=0;i<this.releases.length;i++){
        if(this.releases[i].name===relname){
          return this.releases[i].summary!=null?this.releases[i].summary:'';
        }
      }
        return "";
   },
   getRelDefectSummary(relname){
      for(let i=0;i<this.releases.length;i++){
        if(this.releases[i].name===relname){
          return this.releases[i].defect_summary!=null?this.releases[i].defect_summary:'';
        }
      }
        return "";
   },
         ...
         self1.folderList = folderList;
          ...
          testcaseService.getFolderByProjectIds().then(
              (fdata) => {
                ...
                let p_template = '<div class="releaseContent" style="display:none;">';
...
if(scheme === "dark-scheme"){
  ...
  this.changeScheme('.thirdPage','','thirdPageDefault');
   ...
   this.changeScheme('.b_chartDiv','darkBackground','lightBackground');
    ...
    this.changeScheme('.b_chartDiv1','darkBackground','lightBackground');
    this.changeScheme('.b_chartDiv1','','defaultBackground');
...
this.changeScheme('.belowCharts','','belowChartsDefault');
  ...
  this.changeScheme('.thirdPage','','thirdPageDefault');
   ...
   this.changeScheme('.b_chartDiv','lightBackground','darkBackground');
    this.changeScheme('.b_chartDiv','','defaultBackground');
    this.changeScheme('.b_chartDiv1','lightBackground','darkBackground');
    this.changeScheme('.b_chartDiv1','','defaultBackground');
  ...
  this.changeScheme('.thirdPage','','thirdPageLight');
   ...
   this.changeScheme('.b_chartDiv','','lightBackground');
    this.changeScheme('.b_chartDiv1','defaultBackground','darkBackground');
...
<template>
  <div class="customerReleaseDiv" id="customerReleaseDiv">
    ...
    <div class="dashboardDiv">
      <div>
      <div class="row custSummaryDiv" v-show="summary_customers.length>0">
     ...
     <!-- <div class="summaryBox" :key="index">
      ...
      <div class="summaryBox" :key="index" v-show="summary_obj.showSplide">
      ...
      <div>
       ...
       <div class="nextMilestone" v-show="currentPhase!=''"><div class="currentPhaseStatus"></div> {{currentPhase}}</div>
       </div>
       </div>
       <div class="col-lg-6">
       ...
       <div id="buttonGroup" class="button-row" v-if="ganttOptionFlag">
        ...
        <div class="col-lg-12 col-md-12">
          ...
          <div class="summary_Data">
              ...
              <div class="summaryCircle1 coloredCircleBorder coloredBorder1">
              ...
              <div class="summary_li">
              <div class="summaryCircle2 coloredCircleBorder coloredBorder2">
             ...
             <div class="testcaseLineChart defaultBackground width36Per">
      ...
      <div class="cvtWrapper defaultBackground width36Per">
     ...
     <div class="cvtData" v-show="!showCVTDataTable">
      ...
      <div v-show="showCVTDataTable" class="weeklyExecutionTable">
          ...
          id="defectTabs"
          name="defectTabs"
          :options="{ useUrlFragment: false, defaultTabHash:'componentTab' }"
    ...
    <ExecutionSummaryTable :customerName="customerName"
          :releaseId="selectedRelId"
          :releaseFlag="releaseFlag"
          :folderName="folderName"
		     :weeklyReport="weeklyReport"
          :mainCdets="mainCdets" :execrelName="execrelName" :execProjects="execProjects" v-on:child="onChildInteraction">
    </ExecutionSummaryTable>
    </div>
    <div v-if="showSampleMailModal" class="execSummaryModal">
    <MailSamplePage :releases="releases" :ganttOptions="ganttOptions"
         :cvtOptions="cvtOptions"  :splineOptions="splineOptions"
         v-on:child="onChildInteraction">
    </MailSamplePage>
    </div>
